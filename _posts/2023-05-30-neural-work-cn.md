...
5. 输出： 成本函数的梯度由$$\frac{\partial C}{\partial w^l_{jk}} = a^{l-1}_k \delta^l_j$$给出。
和$$\frac{\partial C}{\partial b^l_j} = \delta^l_j $$
...
> 输出： 成本函数的梯度由$$\frac{\partial C}{\partial w^l_{jk}} = a^{l-1}_k \delta^l_j$$给出。
和$$\frac{\partial C}{\partial b^l_j} = \delta^l_j $$
