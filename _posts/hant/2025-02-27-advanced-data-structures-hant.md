...
public class UnionFind {
    ...
    public static void main(String[] args) {
        ...
        uf.union(2, 3);
        uf.union(1, 4);
        System.out.println("0 和 4 連通: " + (uf.find(0) == uf.find(4)));
        System.out.println("2 和 4 連通: " + (uf.find(2) == uf.find(4)));
    }
}
```
**輸出:**
...
## 3. AVL Tree: 自平衡 BST
AVL Tree 是一種自平衡二元搜索樹，子樹高度差（平衡因子）最多為 1，確保 O(log n) 操作。
...
Binary Indexed Tree (BIT) 高效處理範圍和查詢更新，時間複雜度為 O(log n)，常用於競程編程。
...
## 1. A* 搜索: 启發式路徑查找
A* 是一種有信息的搜索演算法，使用啟發式來查找圖中的最短路徑，結合了 Dijkstra 和貪心搜索的優點。它在遊戲和導航中廣泛使用。
...
public class MonteCarlo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("使用 " + points + " 點估計的 π: " + pi);
