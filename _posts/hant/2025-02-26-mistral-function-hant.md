    ...
    try:
        ...
        if response_json and response_json['choices']:
            ...
            if 'message' in choice and 'content' in choice['message']:
                ...
                print(f"工具呼叫: {tool_calls}")
                return tool_calls # 返回工具呼叫以進行處理
            else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--type", type=str, default="mistral", choices=["mistral", "codestral"], help="要呼叫的 API 類型 (mistral 或 codestral)")
    parser.add_argument("--function_calling", action="store_true", help="啟用 Mistral API 的函數呼叫")
