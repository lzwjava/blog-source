...
我進行了一項測試，以測量我家TP-LINK AX3000無線路由器不同距離的電磁場強度。結果如下：[<sup>1</sup>]

電磁場儀有三個測試模式：磁場、電場和射頻。在無線路由器測試中，我們使用了射頻模式。

上下移動手機可以產生磁場，電磁場儀可以檢測到。[<sup>2</sup>]
