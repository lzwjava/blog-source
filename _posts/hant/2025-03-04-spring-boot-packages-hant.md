...
lang: hant
layout: post
title: 分析 Spring Boot 的包
translated: true
---

開始分析目錄：/Users/lzwjava/projects/spring-boot 於第 2 層，並顯示出現次數：

```bash
[INFO] 開始分析目錄：/Users/lzwjava/projects/spring-boot 於第 2 層，並顯示出現次數
[INFO] 總共嘗試處理的 Java 文件：7485
[INFO] 成功處理：7485
[INFO] 文件出錯：0
[INFO] 總共獨特的套件及其出現次數：204
[INFO] 分析完成。列出獨特的套件及其出現次數（按出現次數降序排列）：
...
開始分析目錄：/Users/lzwjava/projects/spring-boot 於第 3 層，並顯示出現次數。

```bash
[INFO] 開始分析目錄：/Users/lzwjava/projects/spring-boot 於第 3 層，並顯示出現次數
[INFO] 總共嘗試處理的 Java 文件：7485
[INFO] 成功處理：7485
[INFO] 文件出錯：0
[INFO] 總共獨特的套件及其出現次數：498
[INFO] 分析完成。列出獨特的套件及其出現次數（按出現次數降序排列）：
