...
lang: hant
layout: post
title: Spring Boot 套件分析
translated: true
type: note
---

開始分析目錄：/Users/lzwjava/projects/spring-boot，層級 2，包含出現次數：

```bash
[INFO] 開始分析目錄：/Users/lzwjava/projects/spring-boot，層級 2，包含出現次數
[INFO] 嘗試處理的 Java 檔案總數：7485
[INFO] 成功處理：7485
[INFO] 發生錯誤的檔案：0
[INFO] 唯一套件數量（含計數）：204
[INFO] 分析完成。列印唯一套件及計數（按計數降序排列）：
...
開始分析目錄：/Users/lzwjava/projects/spring-boot，層級 3，包含出現次數。

```bash
[INFO] 開始分析目錄：/Users/lzwjava/projects/spring-boot，層級 3，包含出現次數
[INFO] 嘗試處理的 Java 檔案總數：7485
[INFO] 成功處理：7485
[INFO] 發生錯誤的檔案：0
[INFO] 唯一套件數量（含計數）：498
