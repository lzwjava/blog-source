...
搜尋和模擬算法解決路徑查找和概率問題。讓我們探索A*搜尋和蒙特卡羅模擬。

## 1. A* 搜尋：啟發式路徑查找
A* 是一種啟發式搜尋算法，使用啟發式來找到圖中的最短路徑，結合了Dijkstra和貪婪搜尋的優點。它在遊戲和導航中廣泛使用。
...
## 2. 蒙特卡羅模擬：概率估計
蒙特卡羅方法使用隨機抽樣來估計結果，例如通過模擬正方形和圓內的點來近似π。
...
public class MonteCarlo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("使用 " + points + " 個點估計 π: " + pi);
