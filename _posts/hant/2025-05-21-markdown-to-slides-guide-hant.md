...
lang: hant
layout: post
title: Markdown 轉投影片快速指南
translated: true
type: note
---

Marp CLI 讓你能將 Markdown 檔案轉換成簡報（HTML、PDF、PPTX）。如果你希望以純 Markdown 編寫簡報並盡量減少格式調整，它尤其有用。
...
你想讓我提供**一個即用型 Markdown 模板檔案**（包含標題頁、議程、內容和結尾頁）以便你立即開始嗎？