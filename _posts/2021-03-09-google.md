...
<img src="/assets/images/cc/google/zhs.png" alt="zhs" />

然而可能上不去。因为它被长城防火墙阻拦了。



![zhs_user](/assets/images/cc/google/zhs_user.png)
...
![clash_win](/assets/images/cc/google/clash_win.png)

![win_version](/assets/images/cc/google/win_version.png)
...
![clash_win_exe](/assets/images/cc/google/clash_win_exe.png)
...
![zhs_url](/assets/images/cc/google/zhs_url.png)

看下载好了。注意看上面第二个配置。注意到配置前面有个绿色的选中标志。表明我们已经在用这个配置了。



![zhs_proxy](/assets/images/cc/google/zhs_proxy.png)
...
![zhs_node](/assets/images/cc/google/zhs_node.png)



选择了 `US玫瑰`这个节点。

![clash_system](/assets/images/cc/google/clash_system.png)

接着，把`System Proxy`这个设置，切换它的状态，来开启它。就是说将`Clash`软件设成系统的代理层。那么系统的流量将先到`Clash`软件，然后再去访问外网。



<img src="/assets/images/cc/google/google.png" alt="google" style="zoom:40%;" />
...
<img src="/assets/images/cc/google/zhs_register.png" alt="zhs_register" style="zoom:50%;" />

注册好了后。接下来却发现充值购买服务，需要一些步骤。以下是我账号的截图。



![zeng](/assets/images/cc/google/zeng.png)
...
<img src="/assets/images/cc/google/zhs_telegram.png" alt="zhs_telegram" style="zoom:50%;" />
...
![telegram](/assets/images/cc/google/telegram.png)
...
![telegram_username](/assets/images/cc/google/telegram_username.png)
...
<img src="/assets/images/cc/google/zhs_set.png" alt="zhs_set" style="zoom:50%;" />
