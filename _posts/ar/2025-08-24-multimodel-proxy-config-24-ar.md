...
lang: ar
layout: post
title: دليل تكوين الوكيل متعدد النماذج المحدث
translated: true
type: note
---

ها هو - ضع هذا كملف التهيئة المحدث لديك:
...
إذا كان برنامج التشغيل الخاص بك يعرض علامة لقمع تدفقات التفكير على DeepSeek (تسمى أحيانًا `reasoning.exclude` أو ما شابه)، فعّلها لـ `deepseek/deepseek-chat-v3.1` لتجنب مشاكل تحليل واجهة المستخدم.