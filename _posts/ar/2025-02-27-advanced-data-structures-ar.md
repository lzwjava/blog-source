...
شجرة AVL هي شجرة بحث ثنائية ذات توازن ذاتي حيث تختلف ارتفاعات الفرع (عامل التوازن) على الأكثر 1، مما يضمن عمليات O(log n).
...
```
**الخرج:** `Preorder: 30 20 10 25 40 50`

## 4. شجرة الفهرسة الثنائية (شجرة فينويك): استعلام النطاق
تساعد شجرة الفهرسة الثنائية (BIT) في معالجة استعلام مجموع النطاق والتحديثات في وقت O(log n)، وغالبًا ما تستخدم في البرمجة التنافسية.
...
تواجه خوارزميات البحث والتشغيل مشاكل البحث في المسار والتشغيل الاحتمالي. دعونا نستكشف البحث A* والتشغيل الاحتمالي.

## 1. بحث A*: البحث في المسار باستخدام الاستدلال
A* هو خوارزمية بحث مستنيرة تستخدم استدلالًا للبحث عن المسار الأقصر في الرسم البياني، وتجمع بين نقاط القوة في خوارزميات Dijkstra والبحث الجشعي. تستخدم على نطاق واسع في الألعاب والتوجيه.
...
## 2. تشغيل مونتي كارلو: تقدير الاحتمالي
تستخدم طرق مونتي كارلو عينات عشوائية لتقدير النتائج، مثل تقريب π من خلال محاكاة النقاط في مربع ومدور.
