...
lang: ar
layout: post
title: أحد عشر لابز AI
translated: true
---

* رائع. استخدمت 5 دولارًا أمريكيًا لاختبار الخدمة.

* استنساخ الصوت رائع.

* عينات الصوت أدناه:

* [إنجليزي](assets/audios/ElevenLabs.mp3)

* [ياباني](assets/audios/ElevenLabs_1.mp3)

* [إسباني](assets/audios/ElevenLabs_2.mp3)
