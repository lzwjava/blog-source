...
lang: ar
layout: post
title: خوارزميات الرسوم البيانية في جافا
translated: true
type: note
---

تمثل الرسوم البيانية العلاقات، وتقوم خوارزمياتها بحل مشاكل مثل أقصر المسارات والاتصال. دعنا نغطي DFS، BFS، خوارزمية ديكسترا، وخوارزمية كروسكال.

## 1. DFS: البحث بالعمق الأول
يستكشف DFS بأقصى حد ممكن على طول كل فرع قبل التراجع.
...
```
**المخرجات:** `DFS: 2 0 1 3`

## 2. BFS: البحث بالعرض الأول
يستكشف BFS مستوى تلو مستوى باستخدام قائمة انتظار.
...
```
**المخرجات:** `BFS: 2 0 3 1`

## 3. خوارزمية ديكسترا: أقصر المسارات
تجد خوارزمية ديكسترا أقصر مسار في رسم بياني مرجح.
...
```
**المخرجات:** `Distances from 0: [0, 3, 1, 8]`

## 4. خوارزمية كروسكال: شجرة الامتداد الأدنى
تبني خوارزمية كروسكال شجرة امتداد أدنى من خلال فرز الحواف وإضافتها بطريقة جشعة.
