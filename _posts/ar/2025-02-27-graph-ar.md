...
lang: ar
layout: post
title: خوارزميات الجراف في جاڤا
translated: true
---

الرسوم البيانية تنمذل العلاقات، وتحل خوارزمياتها مشاكل مثل الأطوال القصوى والاتصال. دعونا نغطي DFS، BFS، Dijkstra’s، وKruskal’s.

## 1. DFS: البحث بالعمق الأول
DFS يستكشف بقدر الإمكان على كل فرع قبل الرجوع.
...
BFS يستكشف مستوى بعد مستوى باستخدام طابور.
...
## 3. خوارزمية Dijkstra: الأطوال القصوى
Dijkstra’s يجد الأطوال القصوى في رسوم بيانية موزونة.
...
```
**الخروج:** `Distances from 0: [0, 3, 1, 8]`

## 4. خوارزمية Kruskal: شجرة تغطية دقيقة
Kruskal’s يبني شجرة تغطية دقيقة من خلال ترتيب الحواف وتضمينها بشكل جشع.
