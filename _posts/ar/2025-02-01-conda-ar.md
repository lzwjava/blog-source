...
راجع هذا الرابط: [https://www.reddit.com/r/MachineLearning/comments/myl8yn/d_is_anaconda_worth_the_trouble/](https://www.reddit.com/r/MachineLearning/comments/myl8yn/d_is_anaconda_worth_the_trouble/).

لقيت بعض المشاكل مع conda، ومذاك النقاش حول القضايا الماثلة.

مع مرور الوقت، تصبح غير واع من الإعدادات المختلفة للحالة. لذلك، كان علي حذف الآخرين. الآن، أستخدم بشكل أساسي `Python 3.10.9` وأحياناً `Python 3.11.11`. لكنني نادراً أستخدم حتى `Python 3.11.11`. من الناحية الشخصية، لا أحتاج إلى الكثير من الإعدادات. أنا فقط احتاج إلى واحد أو اثنين لتشغيل ما أنا أبحث عنه أو أتعلمه.

أفضل حلاً بسيطاً. إذا كان لدي مشروعان يتعارضان فيما بينهما، فسأفضل استخدام واحد وأغفله الآخر.

على سبيل المثال، يواجه هذه المشكلة يعتبرها صعباً. [^1]
...
رغم أن تحديد بروبكسي لمكون conda بدا سريعاً في البداية، قررت في النهاية إزالته.
...
```
# >>> conda initialize >>>
# !! محتوى داخل هذا الكتله يديره 'conda init' !!
...
بعد إعادة تشغيل iTerm2، قررت الانتقال إلى نصب Python من Homebrew. بدا أن هناك عدة نسخ من Python على جهاز الكمبيوتر؛ كان لدي ستة بالفعل، كما هو موضح أدناه.
...
إزالة باستخدام الأمر، `brew uninstall python@3.11`.
