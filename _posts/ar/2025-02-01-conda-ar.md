...
انظروا إلى هذا الرابط، [https://www.reddit.com/r/MachineLearning/comments/myl8yn/d_is_anaconda_worth_the_trouble/](https://www.reddit.com/r/MachineLearning/comments/myl8yn/d_is_anaconda_worth_the_trouble/).

لدي مشاكل مع conda، وكان آخرون قد ناقشت مشكلات مشابهة.

مع الوقت، تصبح غير واعي بالمواضع المختلفة للبيئة. لذا، كنت مضطراً إلى حذف الآخرين. الآن، أستخدم بشكل رئيسي `Python 3.10.9`، وأحيانًا `Python 3.11.11`. ومع ذلك، أستخدم حتى `Python 3.11.11` بشكل نادر. شخصيًا، لا أحتاج إلى بيئات كثيرة. أنا فقط بحاجة إلى واحدة أو اثنتين للعمل ما أنا أبحث عنه أو أتعلمه.

أفضل حلاً بسيطًا. إذا كان لدي مشروعان يتنافسان مع بعضهما البعض، كنت أفضل استخدام واحد وأترك تشغيل الآخر.

على سبيل المثال، التقاط المشكلة التالية هو مشكلة حقيقية.
...
رغم أن تحديد بروكسي لتسريع conda بدا في البداية، قررت في النهاية إزالته.
