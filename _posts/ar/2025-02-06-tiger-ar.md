...
lang: ar
layout: post
title: واجهة برمجة تطبيقات تجارة تايجر المفتوحة
translated: true
type: post
---

يقوم هذا المقطع من التعليمات البرمجية باسترداد وطباعة أسعار الأسهم الحالية لبعض أكبر الشركات المدرجة في بورصة هونج كونج باستخدام Tiger Open API. يقوم بتهيئة عميل، واسترداد أسعار الأسهم، وطباعة النتائج.
