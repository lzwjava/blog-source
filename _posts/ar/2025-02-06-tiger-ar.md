...
lang: ar
layout: post
title: مثال واجهة برمجة تطبيقات تجارة النمر
translated: true
---

تسترد هذه المقتطفات من التعليمات البرمجية أسعار الأسهم الحالية لبعض أكبر الشركات المدرجة في بورصة هونج كونج باستخدام Tiger Open API.  يقوم بتهيئة عميل، واسترداد أسعار الأسهم، وطباعة النتائج.
