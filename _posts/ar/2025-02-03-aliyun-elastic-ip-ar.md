...
يوفر هذا البرنامج النصي واجهة سطر أوامر لإدارة عناوين IP المرنة من علي بابا كلاود (EIPs).  يسمح لك بإنشاء عناوين EIP وربطها وفصلها وإصدارها باستخدام  Aliyun SDK  لـ Python. يأخذ البرنامج النصي وسيطات للمهمة المراد تنفيذها ومعرف التخصيص لـ EIP.
