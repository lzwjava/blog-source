...
في هذه المقالة، سأتناقش حول DeepSeek v3، مع الإشارة إلى الفيديو "Multi-Head Latent Attention and Multi-token Prediction in Deepseek v3" [https://youtu.be/jL49fLOJYNg?si=4uE2kfe-BlKC1ngO](https://youtu.be/jL49fLOJYNg?si=4uE2kfe-BlKC1ngO). لقد استخدمت خدمة Google Cloud Speech-to-Text لتحويل الفيديو إلى نص، بالإضافة إلى بعض الأكواد لتنظيم النص.

---

أ: مرحبًا بكم مرة أخرى في Deep tag. سنقوم اليوم بالغوص في عالم نماذج اللغة الكبيرة. بالتحديد، DeepSeek V3.

ب: يبدو جيدًا. إنه نموذج يحتوي على 671 مليار معامل، ويحقق نجاحًا كبيرًا بسبب نهجه الفريد في الكفاءة والأداء، أليس كذلك؟

أ: وقد شاركت ورقة أكاديمية توضح بنيته.

ب: نعم.

أ: وكخبير في تعلم الآلة، أنت تتطلع إلى فهم كيف يحقق DeepSeek V3 أداءً عاليًا مع تدريب اقتصادي.
...
أ: أوه، بالتأكيد. هذه فكرة رائعة. نعم، يمكننا بالتأكيد الغوص بشكل أعمق في الانتباه الكامن متعدد الرؤوس، أو MLA. إذن أنت مهتم بالتفاصيل الدقيقة لـ MLA. حسنًا، دعونا نفكك هذا. لقد ذكرنا أن أحد مفاتيح كفاءة DeepSeek V3 هو بنية "خليط الخبراء"، أو MoE، أليس كذلك؟ حيث يتم تنشيط جزء فقط من المعاملات لكل رمز. ويأخذنا DeepSeek V3 خطوة أبعد مع MLA و DeepSeek Mo.

ب: هذا صحيح. لذا دعونا نركز حقًا على MLA الآن.

أ: حسنًا. إذن في التطبيقات في الوقت الفعلي، السرعة أمر بالغ الأهمية.

ب: نعم. وذاكرة التخزين المؤقت للقيم الرئيسية المطلوبة أثناء الاستدلال يمكن أن تكون عائقًا كبيرًا.
...
أ: لكن MLA تقوم بضغط هذه المعلومات بذكاء، حسنًا، لتقليل تدفق الذاكرة المؤقتة بشكل كبير وجعل الاستدلال أسرع بكثير. لذا فهو يشبه أخذ موسوعة ضخمة وتكثيفها إلى النقاط الرئيسية فقط.
...
أ: حسنًا، إذن هو يضغط المفاتيح والقيم، ولكن ماذا يعني ذلك بالضبط؟ إذن دعونا نتعمق قليلاً في الجانب التقني. حسنًا، تأخذ آلية MLA تمثيلًا مخفيًا للإدخال، ثم تقوم بإسقاطه في متجهات الاستعلام والمفاتيح والقيم. حسنًا، الآن هنا تصبح الأمور مثيرة للاهتمام. يقوم MLA بفصل الاستعلام إلى جزأين.
...
أ: إنه يرمز إلى "التضمينات الموضعية الدورانية"، ويساعد النموذج على فهم موقع الرموز في التسلسل. حسنًا، ثم يتم ضغط المفاتيح والقيم في فضاء كامن ذي أبعاد أقل. لذا فهو يشبه تقليص البيانات، مما يوفر في الذاكرة.

ب: بالضبط. لذا يتم حفظ المعلومات الأكثر أهمية، بينما يتم التخلص من الحجم غير الضروري. نعم، وهذا التمثيل المضغوط يسمح بذاكرة تخزين مؤقت أصغر للقيم الرئيسية أثناء الاستدلال، مما يجعل الأمور أسرع.

أ: ويستخدم أيضًا معالجة متعددة الرؤوس.

ب: نعم، تمامًا مثل الانتباه التقليدية، يستخدم MLA رؤوسًا متعددة.
...
ب: بالضبط. إنها طريقة ذكية لتحقيق الانتباه بكفاءة دون التضحية بالأداء.

أ: حسنًا، هذه خدعة رائعة. لكن هل تعلم ماذا؟
...
أ: أنا بالتأكيد... دعنا نرى ما تعنيه. الفضاءات المخفية مثيرة للاهتمام حقًا. نعم، أنت تسأل عن الفضاء المخفي، الفضاء الكامن الذي كنا نتحدث عنه للتو، أليس كذلك؟ أنت مهتم بما يحدث داخل تلك الفضاءات الكامنة، تلك الكهف. نعم، الأمر لا يتعلق فقط بعدد الفضاءات الكامنة، ولكن بما يحدث هناك.

ب: هذا رائع.

أ: بالضبط. هناك بالفعل فضاءان كامنان متميزان داخل MLA، واحد للمحتوى وواحد للقيم الرئيسية. إنه مثل وجود وحدتي تخزين منفصلتين للمعلومات. وهذه الفضاءات الكامنة، كما ناقشنا، تخضع لعمليات Rope، أليس كذلك؟ التضمينات الموضعية الدورانية، التي تضمن المعلومات الموضعية في آلية الانتباه. هذا مهم جدًا لهم. لذا لتلخيص الأمر، يتم فصل الاستعلام، ويتم أيضًا ضغط المفاتيح والقيم.
...
أ: بالضبط. ويتم هذا المعالجة قبل المرحلة التالية من التسلسل. حسنًا، ما الذي يتم تسلسله أثناء مروره عبر كهف الفضاء المخفي؟
...
أ: نعم، وتساعد هذه التسلسلات في دمج المحتوى مع المعلومات الموضعية. ويتم بعد ذلك استخدام هذه التمثيلات المتسلسلة لحساب الانتباه، أليس كذلك؟
...
ب: نعم، إنه مثل وجود فريق حيث يكون لدى الأشخاص تخصصات ولكن يمكنهم أيضًا القيام بأشياء أخرى.

أ: نعم، هذا نهج ذكي جدًا. نعم، ولكن مع وجود العديد من الخبراء المتخصصين، كيف يتأكدون من ألا يصبح أي منهم مثقلًا؟

ب: نعم، بينما يجلس الآخرون دون عمل.

أ: هنا يأتي دور موازنة الحمل الخالية من الخسائر المساعدة المبتكرة.
...
ب: نعم، إنه مثل محاولة إجبار الجميع على استخدام نفس خط الدفع في متجر البقالة.

أ: بالضبط، حتى لو كان بعضهم يتحرك أسرع من الآخرين، أليس كذلك؟ إنه يخلق تأخيرات غير ضرورية فقط.

ب: نعم. لذا يتجنب DeepSeek V3 ذلك عن طريق ضبط مصطلح تحيز ديناميكي، حسنًا، لكل خبير بناءً على حمله. حسنًا، لذا إذا كان خبير ما يتلقى الكثير من الطلبات، فإن النظام يجعله أقل جاذبية قليلاً لآلية التوجيه، مما يحول بعض الحركة إلى خبراء أقل انشغالاً.
...
ب: صحيح. إنه نهج ذكي جدًا لمعالجة عائق حرج.

أ: بالتأكيد. الآن، يجب أن نغطي أيضًا كيف يتعامل DeepSeek V3 مع موازنة حمله.

ب: نعم، بالتأكيد يجب أن نفعل ذلك. هذا أيضًا جزء مهم جدًا من اللغز. يمكننا التطرق إلى ذلك بعد ذلك.

أ: يبدو جيدًا. حسنًا، أعتقد أن هذا يعطيك نظرة عامة رائعة على MLA وفضائه الكامن.

ب: نعم، شكرًا على الغوص في كل التفاصيل معنا. سنعود في المرة القادمة مع المزيد من الغوص العميق.
...
أ: هذا صحيح. وأوه، تفضل.

ج: نعم، يمكننا التحدث عن MTP، كيف... كيف تشارك وحدات MTP تضمينها وكل الأشياء الساخنة...

أ: بالتأكيد. إنه سؤال رائع. نعم، دعنا نتحدث عن كيفية مشاركة وحدات MTP للموارد. إذن أنت مهتم بالتفاصيل الدقيقة لتنفيذ MTP.
...
أ: وهنا تصبح الأمور مثيرة للاهتمام حقًا. نعم، أنت مهتم بكيفية إعداد وحدات MTP وكيف تشارك مواردها. حسنًا، إذن كل وحدة MTP تتضمن طبقة تضمين مشتركة، نعم، ورأس إخراج مشترك. حسنًا، لذا يستخدمون نفس التضمين ورأس الإخراج مثل النموذج الرئيسي.
...
ب: نعم، وهذا مفتاح كفاءة هذا التصميم. حسنًا، إذن إنه مثل نظام من الأجزاء المترابطة التي تعتمد جميعها على بعضها البعض، أليس كذلك؟

أ: وهذا التشارك الفعال للموارد يسمح بتدريب أسرع وأداء أفضل.

ب: حسنًا، هذه خدعة رائعة. هل تعلم ماذا؟

أ: ماذا هناك؟

ب: دعنا ننتقل إلى نظرة عامة أكبر. كيف يتعامل هذا النموذج مع موازنة الحمل؟ كيف يتم اختيار هؤلاء الخبراء؟

أ: نعم، يمكننا بالتأكيد التحدث عن ذلك. حسنًا، الآن دعونا نغوص في استراتيجية موازنة حمل DeepSeek V3.

ب: يبدو جيدًا. حسنًا، إذن يستخدم DeepSeek V3 ما يسمى بالتنبؤ متعدد الرموز.

ج: أوه نعم، نتحدث أكثر عن ذيول MTP.

أ: بالتأكيد... أنا سعيد لأنك مهتم بالغوص بشكل أعمق في MTP. نعم، يمكننا بالتأكيد التفصيل في التنبؤ متعدد الرموز. لذا