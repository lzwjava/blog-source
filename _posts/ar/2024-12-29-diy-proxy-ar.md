...
* استخدم Linode لنقل الخادم بسرعة.  
* قد تحتاج إلى نص برمجي لتجديد خادمك تلقائيًا كل يوم.  
* إذا تم حظر خادم الوكيل بواسطة جدار الحماية العظيم (GFW) أو واجهت مشاكل أخرى، يمكنك استخدام بطاقة SIM من China Telecom Macau لمشاركة بيانات الهاتف المحمول مع جهاز الكمبيوتر المحمول الخاص بك. هذا يسمح لك بإعداد خادم جديد.  
