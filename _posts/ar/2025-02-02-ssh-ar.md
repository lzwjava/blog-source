...
واجهت عمليات `git push` بطيئة، مع تأخيرات تحدث خلال مرحلة `ssh git@github.com`.  للتعامل مع هذا، قمت بتكوين SSH لاستخدام وكيل.

لاستخدام `corkscrew`  لإنشاء نفق SSH، ستحتاج أولاً إلى تثبيته. على macOS، يمكنك استخدام Homebrew باستخدام الأمر: `brew install corkscrew`.
...
تم المصادقة على 138.201.174.0 (عبر وكيل) باستخدام "publickey".
