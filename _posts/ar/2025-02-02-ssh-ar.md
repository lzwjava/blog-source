...
كنت أظن أن عمليات `git push` كانت بطيئة، مع تأخيرات تحدث خلال المرحلة `ssh git@github.com`. في محاولة لتحل هذا، قمت بتكوين SSH للاستخدام عبر خادم وسيط.

لاستخدام `corkscrew` للممرات SSH، عليك أولاً تثبيتها. على macOS يمكنك استخدام Homebrew مع الأمر التالي: `brew install corkscrew`.
...
debug1: قراءة بيانات تكوين /Users/lzwjava/.ssh/config
debug1: /Users/lzwjava/.ssh/config:1: تطبيق خيارات لـ *
debug1: قراءة بيانات تكوين /etc/ssh/ssh_config
debug1: /etc/ssh/ssh_config:21: لا يوجد مطابقة لمقنع /etc/ssh/ssh_config.d/*
debug1: /etc/ssh/ssh_config:54: تطبيق خيارات لـ *
debug2: resolve_canonicalize: 138.201.174.0 هو عنوان
debug3: توسيع UserKnownHostsFile '~/.ssh/known_hosts' إلى '/Users/lzwjava/.ssh/known_hosts'
debug3: توسيع UserKnownHostsFile '~/.ssh/known_hosts2' إلى '/Users/lzwjava/.ssh/known_hosts2'
debug1: لم يتم حل $SSH_SK_PROVIDER؛ تعطيل
debug3: channel_clear_timeouts: مسح
debug1: تنفيذ أمر الخادم الوسيط: exec corkscrew localhost 7890 138.201.174.0 22
debug1: ملف الهوية /Users/lzwjava/.ssh/id_rsa نوع 0
debug1: ملف الهوية /Users/lzwjava/.ssh/id_rsa-cert نوع -1
debug1: سلسلة الترخيص المحلية SSH-2.0-OpenSSH_9.8
debug1: نسخة البروتوكول البعيدة 2.0، برمجيات البعيدة OpenSSH_9.6p1 Ubuntu-3ubuntu13.5
debug1: compat_banner: مطابقة OpenSSH_9.6p1 Ubuntu-3ubuntu13.5 مع OpenSSH* compat 0x04000000
debug2: تعيين O_NONBLOCK على 5
debug2: تعيين O_NONBLOCK على 4
debug1: تصديق إلى 138.201.174.0:22 باسم 'root'
debug3: record_hostkey: وجد نوع المفتاح ED25519 في ملف /Users/lzwjava/.ssh/known_hosts:164
debug3: record_hostkey: وجد نوع المفتاح RSA في ملف /Users/lzwjava/.ssh/known_hosts:165
debug3: record_hostkey: وجد نوع المفتاح ECDSA في ملف /Users/lzwjava/.ssh/known_hosts:166
debug3: load_hostkeys_file: تم تحميل 3 مفاتيح من 138.201.174.0
debug1: load_hostkeys: fopen /Users/lzwjava/.ssh/known_hosts2: No such file or directory
debug1: load_hostkeys: fopen /etc/ssh/ssh_known_hosts: No such file or directory
debug1: load_hostkeys: fopen /etc/ssh/ssh_known_hosts2: No such file or directory
debug3: order_hostkeyalgs: لدينا نوع المفتاح أفضل التنسيق ssh-ed25519-cert-v01@openssh.com، استخدام HostkeyAlgorithms لا يتغير
