---
layout: post
title: "Google Cloud Is Very Expensive"
---
...
In the latest month, I spent around 75 SGD on Google Cloud. This was basically for just one compute engine instance (2 vCPU, 1 10GB disk, Jurong West, Singapore).
