...
lang: fr
layout: post
title: Conseils d'optimisation de réseau
translated: true
---

Utile, Recommandé :

- Privilégiez une connexion WiFi 5G ou un câble Ethernet.
...
- [Afficher les paramètres proxy avant d'exécuter les commandes](./preexec-en)

- [Solutions proxy en Chine - 2025](./proxy-en)

- [Gestion des adresses IP élastiques Aliyun](./aliyun-elastic-ip-en)
...
- [Essayer V2Ray : Un guide étape par étape](./v2ray-en)

- [Script V2Ray](./v2ray-script-en)

- [Améliorer OpenWRT avec OpenClash et Shadowsocks](./openwrt-hack-en)

- [Gestion des instances AWS Lightsail](./lightsail-en)

- [Gestion des adresses IP réservées DigitalOcean](./reserved-ip-en)
