...
- Beaucoup du travail peut être fait avant de commencer à travailler. On peut se familiariser avec presque tout à l'avance. Tout a un substitut de code ou des matériaux open-source.
...
- Anticipez la prochaine phase du projet. Pensez à la manière dont le projet actuel va progresser et à ce que les utilisateurs auront besoin ou s'attendront.
...
- Pensez à ce que nous pourrions accomplir si tout le monde faisait de son mieux et que nous avions 50 ingénieurs comme ceux-ci.
...
- Les problèmes ou bugs similaires se reproduiront à plusieurs reprises tout au long de votre carrière, alors assurez-vous de prendre des notes à leur sujet. Cette pratique reste utile même à l'ère de l'IA. Parfois, les grands modèles de langage fournissent des réponses qui ne sont pas entièrement exactes et nécessitent que vous les vérifiiez.

- Dans certaines grandes entreprises, l'évolution des chatbots IA ou des outils IA internes peut être lente. Nous pouvons utiliser nos ordinateurs personnels pour apprendre les technologies publiques liées avec des outils IA après le travail. Cela rend le travail sur les ordinateurs d'entreprise moins fastidieux puisque nous sommes déjà familiers avec beaucoup de choses.