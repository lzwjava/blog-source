...
Cet extrait de code récupère et affiche les cours actuels des actions de certaines des plus grandes entreprises cotées à la bourse de Hong Kong à l'aide de l'API ouverte Tiger. Il initialise un client, récupère les cours des actions et affiche les résultats.
