...
* [Opérations avancées et principes de Git](#Git)
* [WebSocket](#websocket)
* [UnitTest](#unittest)
* [Technologie de diffusion en direct sans réserve](#live)

Nous vous invitons à échanger, si vous avez des questions, veuillez créer un [issue](https://github.com/lzwjava/Keynotes/issues/new), nous répondrons dès que possible.

## Live

### Technologie de diffusion en direct sans réserve

Dans le répertoire Live.
...
2016.4.23 Partage de la réunion d'échange de technologies.
...
2015.12.20 Keynote diffusé en direct sur Douyu TV, sur les tests unitaires, l'automatisation, les outils pratiques, etc. Vidéo: http://reviewcode.cn/video.html?videoId=2
...
Merci à Yanzu, ufosky, tang3w, sunng87, iOS 程序猿, Ran Shen. Merci au CTO de LeanCloud pour m'avoir permis de parler du processus de test interne.