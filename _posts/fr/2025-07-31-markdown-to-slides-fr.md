...
lang: fr
layout: post
title: Markdown vers diapositives en quelques minutes
translated: true
type: note
---
...
* `---` (YAML frontmatter) active Marp et la configuration.
...
* **Inclure les notes de l'orateur** :
  ...
  <!--
  Ce sont des notes pour l'orateur
  -->
  ```
...
* Elle affiche un aperçu en direct pendant l'édition du Markdown.
