...
Le script identifie les adresses IP actives. Pour assurer une communication réseau correcte, vérifiez que les paramètres proxy sont configurés pour contourner ces IP locales.
