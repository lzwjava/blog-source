...
* Utilisez Gemini ou Grok pour générer des images de célébration de festivals avec des invites comme "Générer une image de Nouvel An du Serpent Lunaire heureux avec des noms inclus".

* [Messages de Commit Git Alimentés par l'IA](./gitmessageai-en)

* [Génération d'Audio de Conversation](./conversation-style-en)
