...
Les structures de données sont le fondement des algorithmes efficaces. Explorons quatre structures puissantes : Skip List, Union-Find, AVL Tree et Binary Indexed Tree. Elles sont largement utilisées dans des scénarios nécessitant des recherches, des unions, de l'équilibrage ou des requêtes de plage rapides.

## 1. Skip List : Recherche Probabiliste
Une skip list est une liste chaînée à plusieurs niveaux qui permet une recherche, une insertion et une suppression rapides avec une complexité temporelle moyenne de O(log n), offrant une alternative aux arbres équilibrés.
...
## 2. Union-Find (Ensembles Disjoints) : Suivi de la Connectivité
Union-Find gère efficacement les ensembles disjoints, supportant les opérations d'union et de recherche en un temps amorti quasi O(1) avec la compression de chemin et les heuristiques de rang.
...
## 3. Arbre AVL : Arbre Binaire de Recherche Auto-Équilibré
...
```
**Sortie :** `Preorder : 30 20 10 25 40 50`

## 4. Arbre Indexé Binaire (Arbre de Fenwick) : Requêtes de Plage
...
public class BinaryIndexedTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Somme de la plage 2 à 5 : " + bit.rangeSum(2, 5));
        bit.update(3, 6); // Ajoute 6 à l'index 3
        System.out.println("Nouvelle somme de la plage 2 à 5 : " + bit.rangeSum(2, 5));
    }
}
```
**Sortie :**
```
Somme de 0 à 5 : 12
Somme de la plage 2 à 5 : 9
Nouvelle somme de la plage 2 à 5 : 15
```
...
Les algorithmes de recherche et de simulation résolvent des problèmes de recherche de chemin et de probabilités. Explorons A* Search et Monte Carlo Simulation.

## 1. A* Search : Recherche de Chemin Heuristique
...
Les méthodes de Monte Carlo utilisent l'échantillonnage aléatoire pour estimer des résultats, comme l'approximation de π en simulant des points dans un carré et un cercle.
...
public class MonteCarlo {
    static double estimatePi(int points) {
        ...
        return 4.0 * insideCircle / points; // Ratio * 4 approxime π
    }
...
```
**Sortie (varie selon l'aléatoire) :**
```
