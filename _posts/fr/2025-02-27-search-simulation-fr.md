...
A* est un algorithme de recherche informé qui utilise une heuristique pour trouver le plus court chemin dans un graphe, combinant les forces de Dijkstra et de la recherche gloutonne. Il est largement utilisé dans les jeux et la navigation.
