...
lang: fr
layout: post
title: Mistral Appel de Fonction
translated: true
type: note
---
                    ...
                    "function": {
                        ...
                        "parameters": {
                            ...
                            "properties": {
                                "location": {
                                    "type": "string",
                                    "description": "La ville et l'état, ex. Paris, France",
                                },
    ...
    try:
        ...
        if response_json and response_json['choices']:
            ...
            if 'message' in choice and 'content' in choice['message']:
                ...
                return tool_calls # Retourner les appels d'outils pour traitement
            else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Tester les APIs Mistral et Codestral.")
    ...
    if args.type == "mistral":
        prompt = "Quel temps fait-il à Londres ?"
