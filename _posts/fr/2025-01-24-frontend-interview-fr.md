...
lang: fr
layout: post
title: Ingénieur Frontend Entretien
translated: true
---
...
5. Liens et ancres : Comprendre les balises `<a>`, les attributs `href`, `target` et `download`.
...
14. Conception réactive : Utiliser les requêtes média, la balise méta viewport et les images réactives.
