...
Les graphes modélisent des relations et leurs algorithmes résolvent des problèmes comme les plus courts chemins et la connectivité. Voyons DFS, BFS, Dijkstra et Kruskal.

## 1. DFS : Depth-First Search
DFS explore aussi loin que possible le long de chaque branche avant de revenir en arrière.
...
## 3. Algorithme de Dijkstra : Plus courts chemins
...
```
**Sortie :** `Distances from 0: [0, 3, 1, 8]`

## 4. Algorithme de Kruskal : Arbre couvrant minimal
L'algorithme de Kruskal construit un arbre couvrant minimal en triant les arêtes et en les ajoutant de manière gloutonne.
