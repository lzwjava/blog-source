...
- Utilisez un compte bancaire dédié pour le trading P2P lors de l'achat de cryptomonnaies en Chine. Cela facilite l'enregistrement de vidéos ou la capture d'écrans, permettant aux marchands de vérifier l'historique des transactions, car celui-ci est court.
...
- Il est préférable de détenir la cryptomonnaie native d'un réseau ; par exemple, SOL sur Solana, ou ETH sur Ethereum. Celles-ci peuvent être utilisées pour les frais de transaction et sont largement utilisées sur les principales plateformes d'échange de cryptomonnaies ou les DEX.
...
- L'importance des pensées ou des actions de quiconque devrait être relative à leur capitalisation boursière. Comme je détiens peu d'actifs, mes pensées ont peu d'impact sur le marché global.
