...
lang: fr
layout: post
title: Transistors bipolaires à jonction (Graphique)
translated: true
type: note
---
...
<svg viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Titre -->
  <text x="400" y="30" font-family="Arial" font-size="24" text-anchor="middle" font-weight="bold">Caractéristiques et Fonctionnement du BJT</text>
  
  <!-- Graphique des Caractéristiques de Sortie -->
  <g transform="translate(50, 80)">
    <!-- Titre du Graphique -->
    <text x="175" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Caractéristiques de Sortie (Ic vs Vce)</text>
    ...
    <!-- Étiquettes des Axes -->
    <text x="175" y="230" font-family="Arial" font-size="14" text-anchor="middle">Tension Collecteur-Émetteur (Vce)</text>
    <text x="-40" y="100" font-family="Arial" font-size="14" text-anchor="middle" transform="rotate(-90, -40, 100)">Courant Collecteur (Ic)</text>
    ...
    <text x="175" y="60" font-family="Arial" font-size="14" fill="#006600" text-anchor="middle">Région Active</text>
    <path d="M 100 40 L 340 40" stroke="#006600" stroke-width="1" stroke-dasharray="4,2" />
    
    <text x="300" y="180" font-family="Arial" font-size="14" fill="#660066" text-anchor="middle">Blocage</text>
    <path d="M 300 185 L 300 200" stroke="#660066" stroke-width="1" stroke-dasharray="4,2" />
  </g>
  
  <!-- Graphique des Caractéristiques de Transfert -->
  <g transform="translate(450, 80)">
    <!-- Titre du Graphique -->
    <text x="150" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Caractéristiques de Transfert (Ic vs Ib)</text>
    ...
    <!-- Étiquettes des Axes -->
    <text x="150" y="230" font-family="Arial" font-size="14" text-anchor="middle">Courant de Base (Ib)</text>
    <text x="-40" y="100" font-family="Arial" font-size="14" text-anchor="middle" transform="rotate(-90, -40, 100)">Courant Collecteur (Ic)</text>
  ...
  <!-- Symbole BJT et Flux de Courant (NPN) -->
  <g transform="translate(50, 350)">
    <!-- Titre -->
    <text x="175" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Fonctionnement du Transistor NPN</text>
    ...
    <text x="130" y="50" font-family="Arial" font-size="12" text-anchor="end">Contrôle</text>
    <text x="220" y="40" font-family="Arial" font-size="14" text-anchor="start">Collecteur (C)</text>
    <text x="220" y="160" font-family="Arial" font-size="14" text-anchor="start">Émetteur (E)</text>
    ...
    <!-- Étiquettes de Courant -->
    <text x="120" y="90" font-family="Arial" font-size="14" fill="#ff6600">IB (faible)</text>
    <text x="150" y="30" font-family="Arial" font-size="14" fill="#0066cc">IC (élevé)</text>
    <text x="150" y="185" font-family="Arial" font-size="14" fill="#009933">IE = IB + IC</text>
    
    <!-- Formule -->
    <text x="100" y="210" font-family="Arial" font-size="16">Gain en Courant : β = IC/IB (typiquement 50-200)</text>
  </g>
  
  <!-- Régions de Fonctionnement du BJT -->
  <g transform="translate(450, 350)">
    <!-- Titre -->
    <text x="150" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Régions de Fonctionnement du BJT</text>
    ...
    <text x="50" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">Blocage</text>
    ...
    <text x="250" y="95" font-family="Arial" font-size="12" text-anchor="middle">Interrupteur ON</text>
    
    <!-- États de Polarisation des Jonctions -->
    <rect x="0" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="50" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE : Inverse</text>
    <text x="50" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC : Inverse</text>
    
    <rect x="100" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="150" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE : Directe</text>
    <text x="150" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC : Inverse</text>
    
    <rect x="200" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="250" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE : Directe</text>
    <text x="250" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC : Directe</text>
    
    <!-- Informations Supplémentaires -->
    <text x="150" y="210" font-family="Arial" font-size="14" text-anchor="middle">BE = Jonction Base-Émetteur</text>
    <text x="150" y="230" font-family="Arial" font-size="14" text-anchor="middle">BC = Jonction Base-Collecteur</text>
  </g>
