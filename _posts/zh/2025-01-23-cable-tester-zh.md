...
最近，我在京东购买了一款网络电缆测试仪。之前，我见过网络顾问到我家里或雇主办公室测试网络。

这款设备非常便宜，仅需约10元人民币。在沃尔玛，类似产品售价约为10美元。

本文中，我使用了Amazon.com上的图片。
...
2025年春节期间，有几天我们全家住在大房子里，再次遇到WiFi网络质量不佳的问题。为此，我又购买了一台网状路由器——中兴AC1200，价格约为108元人民币。

沃尔玛上类似的产品有TP-Link WiFi网状路由器、Eero双频网状路由器和NetGear Nighthawk AX3000。这些产品大多价格在50美元到200美元之间。
...
如果你能访问主路由器，就能看到连接的设备及其IP地址。然后，你可以尝试访问每个设备，以确定哪个是子路由器。在我的情况下，它是192.168.1.23，这是中兴AC1200网状路由器的地址。

对于在家中移动的手机，使用2.4 GHz频段更为稳定。而对于通常在卧室或书房使用的笔记本电脑或台式电脑，使用5 GHz频段则更快。
