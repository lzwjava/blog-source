...
02/04/2025 02:07:57 - [INFO] -BCEmbedding.models.EmbeddingModel->>>    正在从 `maidalun1020/bce-embedding-base_v1` 加载。
02/04/2025 02:07:57 - [INFO] -BCEmbedding.models.EmbeddingModel->>>    执行设备：cpu；GPU数量：0；使用fp16：False；embedding池化类型：cls；信任远程代码：False
提取embeddings：100%| 1/1 [00:00<00:00,  1.21it/s]
```
