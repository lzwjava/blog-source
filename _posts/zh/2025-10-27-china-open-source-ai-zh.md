...
确实如此——中国的阿里巴巴（推出Qwen3）和深度求索等公司持续发布开源前沿模型，在推理、语言任务和效率等关键基准测试中直接超越了Meta的Llama 3.1。例如，DeepSeek-V3和Qwen系列模型在Hugging Face等全球排行榜上位居前列，有时凭借混合专家架构等巧妙优化，仅用少得多的算力就能实现。到2025年中期，中国在开源大语言模型前五名中已占据四席。
