...
* **近期发展**:
  ...
  * DeepSeek 计划在 2025 年底前发布一款新的 AI 智能体，旨在与 OpenAI 的产品竞争。([彭博社][1])
...
* **近期发展**:
  ...
  * Z.ai 已完成品牌重塑，并积极推广 GLM-4.5 作为 Anthropic 的 Claude 等模型的具有成本效益的替代品，提供有竞争力的定价和性能。([路透社][2])
...
* **近期发展**:
  ...
  * Mistral 持续在 Apache 2.0 许可证下发布模型，确保可访问性并促进社区贡献。([Mistral AI 文档][3])
...
* **近期发展**:
  ...
  * Moonshot AI 持续增强 Kimi 的能力，旨在为各种应用提供高性价比的 AI 解决方案。([维基百科][4])
...
* **近期发展**:
  ...
  * Qwen 3 持续被整合到阿里的生态系统中，在不同平台上提供 AI 能力。([维基百科][5])
...
[1]: https://www.bloomberg.com/news/articles/2025-09-04/deepseek-targets-ai-agent-release-by-end-of-year-to-rival-openai?utm_source=chatgpt.com "中国的 DeepSeek 准备在年底前发布 AI 智能体以与 OpenAI 竞争..."
[2]: https://www.reuters.com/technology/chinas-ai-startup-zhipu-offers-plan-claude-ai-users-migrate-its-own-model-2025-09-05/?utm_source=chatgpt.com "中国 AI 初创公司智谱为 Claude AI 用户提供迁移至其自身模型的方案"
[3]: https://docs.mistral.ai/getting-started/models/models_overview/?utm_source=chatgpt.com "模型概览"
