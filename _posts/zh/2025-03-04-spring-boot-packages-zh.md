...
lang: zh
layout: post
title: Spring Boot 中分析包
translated: true
---

开始分析目录：/Users/lzwjava/projects/spring-boot 级别 2 及其出现次数：

```bash
[INFO] 开始分析目录：/Users/lzwjava/projects/spring-boot 级别 2 及其出现次数
[INFO] 总尝试的 Java 文件：7485
[INFO] 成功处理：7485
[INFO] 文件出错：0
[INFO] 总唯一包及其计数：204
[INFO] 分析完成。打印唯一包及其计数（按计数降序排序）：
...
开始分析目录：/Users/lzwjava/projects/spring-boot 级别 3 及其出现次数。

```bash
[INFO] 开始分析目录：/Users/lzwjava/projects/spring-boot 级别 3 及其出现次数
[INFO] 总尝试的 Java 文件：7485
[INFO] 成功处理：7485
[INFO] 文件出错：0
[INFO] 总唯一包及其计数：498
