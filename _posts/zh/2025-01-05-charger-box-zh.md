...
人们可以发明一个充电盒。这个盒子就像超声波清洁器。当我用完一个充电宝时，我只需把它放在充电盒里。几个小时后，充电宝就充满电了。

这真的很有趣。也许家里的所有便携式电子产品都可以实现某种协议，使它们能够无线充电。它们都连接到云服务器，并且有一个充电盒。你只需要把蓝牙音箱、手机、电灯、笔记本电脑放进盒子里，智能手表放进大充电盒里。然后它们就可以充电了。这就像大超市里的智能收银机。

就像无线充电宝可以把能量传递给iPhone一样，充电盒可以把能量从它传递到盒子里的电子产品。这就像MagSafe充电器。
