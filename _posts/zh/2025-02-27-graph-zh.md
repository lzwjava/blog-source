...
图模型关系，它们的算法解决了最短路径和连通性等问题。我们来介绍DFS、BFS、Dijkstra和Kruskal。

## 1. DFS: 深度优先搜索
DFS 在每个分支上尽可能深入，然后回溯。
...
public class Dijkstra {
    static class Graph {
        ...
        void dijkstra(int src) {
            ...
            System.out.println("从 " + src + " 的距离: " + Arrays.toString(dist));
        }
    }
