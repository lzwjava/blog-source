...
The upper segment is for distance vision, and the lower segment is for near vision. The issue with bifocals is that when you look at a blackboard and use a computer, you use the distance vision part, which is the upper part of your eyeglasses. The way they use the upper segment for distance vision and the lower segment for near vision is wrong.
