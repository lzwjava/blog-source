...
Ich hatte langsame `git push`-Operationen mit Verzögerungen während der `ssh git@github.com`-Phase. Um dies zu beheben, habe ich SSH so konfiguriert, dass es einen Proxy verwendet.
...
Authentifiziert bei 138.201.174.0 (über Proxy) mit "publickey".
