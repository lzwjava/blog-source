...
lang: de
layout: post
title: Graph-Algorithmen in Java
translated: true
---

Graphen modellieren Beziehungen, und ihre Algorithmen lösen Probleme wie kürzeste Wege und Konnektivität. Lassen Sie uns DFS, BFS, Dijkstra und Kruskal behandeln.

## 1. DFS: Tiefensuche
DFS erkundet so weit wie möglich entlang jedes Zweigs, bevor es zurückverfolgt.
...
## 2. BFS: Breitensuche
BFS erkundet Ebene für Ebene mit einer Warteschlange.
...
## 3. Dijkstra-Algorithmus: Kürzeste Wege
...
public class Dijkstra {
    static class Graph {
        ...
        void dijkstra(int src) {
            ...
            System.out.println("Abstände von " + src + ": " + Arrays.toString(dist));
        }
    }
...
```
**Ausgabe:** `Abstände von 0: [0, 3, 1, 8]`

## 4. Kruskal-Algorithmus: Minimaler Spannbaum
Kruskal baut einen MST, indem er Kanten sortiert und sie gierig hinzufügt.
