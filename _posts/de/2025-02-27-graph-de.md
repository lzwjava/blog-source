...
lang: de
layout: post
title: Graphenalgorithmen in Java
translated: true
type: note
---

Graphen modellieren Beziehungen und ihre Algorithmen lösen Probleme wie kürzeste Pfade und Konnektivität. Lassen Sie uns DFS, BFS, Dijkstra und Kruskal behandeln.

## 1. DFS: Depth-First Search
DFS erkundet so weit wie möglich entlang jedes Astes, bevor es zurückverfolgt.
...
BFS erkundet Ebene für Ebene unter Verwendung einer Warteschlange.
...
Dijkstra findet den kürzesten Pfad in einem gewichteten Graphen.
...
```
**Ausgabe:** `Distances from 0: [0, 3, 1, 8]`

## 4. Kruskal’s Algorithm: Minimum Spanning Tree
Kruskal baut einen MST durch Sortieren von Kanten und deren gieriger Hinzufügung.
