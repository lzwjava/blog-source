...
lang: de
layout: post
title: Wi-Fi-Signalstärke in macOS
translated: true
---

Um die Stärke Ihres Wi-Fi-Signals zu überprüfen, verwenden Sie den folgenden Befehl. Die Ausgabe wird eine Zeile enthalten, die ähnlich wie diese aussieht: `Signal / Noise: -47 dBm / -90 dBm`.
