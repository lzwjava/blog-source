...
lang: de
layout: post
title: Fehler bei der Initialisierung des Spring Servlet-Kontexts
translated: true
type: note
---

[WARNUNG] org.aspectj.runtime.reflect.StringMaker wurde von mehreren Orten gescannt: jar:file:///Users/lzwjava/.m2/repository/org/aspectj/aspectjrt/1.9.24/aspectjrt-1.9.24.jar!/org/aspectj/runtime/reflect/StringMaker.class, jar:file:///Users/lzwjava/.m2/repository/org/aspectj/aspectjweaver/1.9.24/aspectjweaver-1.9.24.jar!/org/aspectj/runtime/reflect/StringMaker.class
[WARNUNG] org.aspectj.runtime.reflect.UnlockSignatureImpl wurde von mehreren Orten gescannt: jar:file:///Users/lzwjava/.m2/repository/org/aspectj/aspectjrt/1.9.24/aspectjrt-1.9.24.jar!/org/aspectj/runtime/reflect/UnlockSignatureImpl.class, jar:file:///Users/lzwjava/.m2/repository/org/aspectj/aspectjweaver/1.9.24/aspectjweaver-1.9.24.jar!/org/aspectj/runtime/reflect/UnlockSignatureImpl.class
[INFO] Scan-Dauer=100ms
[INFO] Keine Spring WebApplicationInitializer-Typen auf dem Classpath erkannt
[INFO] DefaultSessionIdManager workerName=node0
[INFO] Kein SessionScavenger gesetzt, verwende Standardeinstellungen
[INFO] node0 Bereinigung alle 600000ms
[INFO] Initialisiere Spring DispatcherServlet 'dispatcher'
2025-09-05T06:47:58.656+08:00 INFO  main trace- o.s.web.servlet.DispatcherServlet        :
                Initialisiere Servlet 'dispatcher'
2025-09-05T06:47:58.705+08:00 WARN  main trace- .s.AnnotationConfigWebApplicationContext :
                Ausnahme während der Kontextinitialisierung - Aktualisierungsversuch wird abgebrochen: org.springframework.beans.factory.BeanDefinitionStoreException: Fehler beim Parsen der Konfigurationsklasse [org.lzw.AppConfig]; verschachtelte Ausnahme ist java.io.FileNotFoundException: Klassenpfad-Ressource [jakarta/servlet/Filter.class] kann nicht geöffnet werden, da sie nicht existiert
2025-09-05T06:47:58.706+08:00 ERROR main trace- o.s.web.servlet.DispatcherServlet        :
                Kontextinitialisierung fehlgeschlagen
org.springframework.beans.factory.BeanDefinitionStoreException: Fehler beim Parsen der Konfigurationsklasse [org.lzw.AppConfig]; verschachtelte Ausnahme ist java.io.FileNotFoundException: Klassenpfad-Ressource [jakarta/servlet/Filter.class] kann nicht geöffnet werden, da sie nicht existiert
