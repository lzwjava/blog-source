...
lang: de
layout: post
title: Tiger Trade Open-API-Beispiel
translated: true
---

Dieser Code-Snippet ruft die aktuellen Aktienkurse einiger der größten an der Hong Kong Stock Exchange notierten Unternehmen mithilfe der Tiger Open API ab und gibt sie aus. Er initialisiert einen Client, ruft die Aktienkurse ab und gibt die Ergebnisse aus.
