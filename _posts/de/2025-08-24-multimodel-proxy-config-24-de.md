...
lang: de
layout: post
title: Aktualisierter Multi-Modell-Proxy-Konfigurationsleitfaden
translated: true
type: note
---

Hier hast du es—füge dies als deine aktualisierte Konfiguration ein:
...
Wenn dein Runner eine Flag zum Unterdrücken von Reasoning-Streams bei DeepSeek bereitstellt (manchmal genannt `reasoning.exclude` oder ähnlich), aktiviere sie für `deepseek/deepseek-chat-v3.1`, um UI-Parsing-Probleme zu vermeiden.