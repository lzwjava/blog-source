...
5. **LightDM installieren und konfigurieren:**
   - Wenn das Problem weiterhin besteht, können Sie versuchen, einen alternativen Display Manager zu installieren:
     ```bash
     sudo apt-get install lightdm
     ```
   - Nach der Installation von lightdm werden Sie aufgefordert, den Standard-Display-Manager festzulegen.
