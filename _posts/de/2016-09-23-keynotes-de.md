...
* [Git Fortgeschrittene Operationen und Prinzipien](#Git)
* [WebSocket](#websocket)
* [UnitTest](#unittest)
* [Vollständige Live-Streaming-Technologie](#live)

Feedback ist willkommen, Fragen bitte als [Issue](https://github.com/lzwjava/Keynotes/issues/new) hinzufügen, ich werde sie so schnell wie möglich beantworten.

## Live

### Vollständige Live-Streaming-Technologie

Im Verzeichnis Live.

## Git
2016.5.3 Doushu Live
...
2016.4.23 Technik-Austauschtreffen-Präsentation.
...
2015.12.20 Live auf Doushu TV, Keynote über Unit-Tests, Automatisierung, nützliche Tools usw. Video: http://reviewcode.cn/video.html?videoId=2
...
Dank an Yanzu, Ufosky, Tang3w, Sunng87, iOS-Programmierer, Ruanshen. Dank an LeanCloud CTO für die Erlaubnis, die interne Testprozesse zu erläutern.