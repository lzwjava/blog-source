...
* Gemini oder Grok verwenden, um Bilder für Festlichkeiten zu generieren, mit Eingabeaufforderungen wie „Generiere ein fröhliches Bild zum Mondneujahrsfest des Schlangenjahres mit eingefügten Textnamen“.
...
* Vermeiden Sie bei der Bereitstellung von ausreichendem Kontext für Aufgaben wie Übersetzung oder Generierung von Dialogtexten die Verwendung von Chain-of-Thought-Funktionen, da dies langsam sein und zu ausführlichen oder nicht hilfreichen Antworten führen kann.
...
* Ein Grund, warum wir Postman oder Figma im KI-Zeitalter nicht verwenden, ist, dass ihre Funktionalitäten nicht durch Text generiert werden können. Ihnen fehlt auch eine Befehlstaste + K-Verknüpfung zum Auslösen des Komponentenersatzes.
