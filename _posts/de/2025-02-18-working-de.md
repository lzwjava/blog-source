...
- **Bevor Sie Zugriff auf das Code-Repository erhalten**, fragen Sie Ihre Kollegen nach der `pom.xml`-Datei und versuchen Sie, Nexus-Abhängigkeiten herunterzuladen.
...
- **Vorbereiten** Sie die nächste Phase des Projekts. Überlegen Sie, wie das aktuelle Projekt voranschreiten wird und was die Benutzer benötigen oder erwarten.
...
- Überlegen Sie, wie Sie dieses Wissen den neu hinzugekommenen Teammitgliedern vermitteln können.
