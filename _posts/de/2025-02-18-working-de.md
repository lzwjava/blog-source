...
- Ohne den eigentlichen Code, aber mit den Nexus-Bibliotheken, können wir tatsächlich das JAR dekompilieren oder mit den Bibliotheken experimentieren. Wir können eine Menge tun. Denken Sie außerhalb der Box.

- Es ist vorzuziehen, **Benutzer-Token** im Sonatype Nexus Repository in `settings.yaml` zu **konfigurieren**.

- Warten Sie nicht auf ServiceNow-Anfragen. Bevor Sie Zugriffsrechte haben, denken Sie darüber nach, was Sie tun können.

- Viel von der Arbeit kann erledigt werden, bevor Sie mit der Arbeit beginnen. Man kann sich mit fast allem im Voraus vertraut machen. Es gibt für alles Ersatzcode oder Materialien aus Open Source.
...
- Überlegen Sie, wie ein Ingenieur an diesem Projekt für 5 oder 10 Jahre arbeiten könnte, und denken Sie darüber nach, wie Sie ähnliche Effizienz schnell erreichen können.
...
- Überlegen Sie, was wir erreichen könnten, wenn jeder sein Bestes gibt und wir 50 solche Ingenieure haben.
...
- Anstatt Jira oder Confluence zu durchsuchen, verwenden Sie direkt Mitarbeiter-IDs, um ihre Seiten zu finden und ihre Aktivitäten zu verstehen.
