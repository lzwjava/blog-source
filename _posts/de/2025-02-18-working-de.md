...
- Wenn wir auf ein Problem stoßen, z.B. wenn `npm run build` in einer großen Build-Pipeline Probleme hat, können wir es getrennt ausführen, um sicherzustellen, dass es funktioniert, bevor die gesamte Pipeline ausgeführt wird. Dies macht den Debug-Zyklus schneller und kleiner.