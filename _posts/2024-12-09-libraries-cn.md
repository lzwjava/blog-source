...
升级过程变得非常麻烦，因为我的代码与 CodeIgniter 框架紧密耦合。参考升级指南 https://codeigniter4.github.io/CodeIgniter4/installation/upgrade_4xx.html 可以看出，更新代码库需要投入大量工作。
