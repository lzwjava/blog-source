...
<div align="center"><img src="/assets/images/agi/tom.jpg" width="100%" /><img/></div>

Quick Take:

In the 10x AGI information world:

1. Jira and Confluence are outdated.
2. AI-powered Work Center = Jira + Confluence + GitHub + Teams.
3. Every knowledge worker will become an AI-powered full-stack worker.
4. Every worker should be automatically paid according to the information created.
5. Everyone can use their preferred language to do most of the work as long as they can create the code. 
6. We need a small movable portable room to control the temperature, humidity, and air quality surrounding us when we are not in our homes or car. 
7. 10x data, 10x code, so 10x information, 10x processing speed.
