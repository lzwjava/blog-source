...
And if user B couldn't receive money, he wants to report this to the PayGPT company. So he tells the PayGPT to check this. So the issues are created by some conversation messages of user A and those of user B. 