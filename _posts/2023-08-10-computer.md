...
We ask an expert for two times to check why our computer couldn't start up. One is that the motherboard power supply connector is loose. The other reason is that the front panel start button connector is loose.
