...
def gitmessageai(push=True, only_message=False):
    ...
    # Obtener el diff de los cambios preparados
...
"""    
    ...
    # Enviar el prompt a la API de DeepSeek
    ...
    # Hacer commit con el mensaje generado
    ...
    if push:
        ...
        print("Cambios confirmados localmente, pero no se hicieron push.")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Genera un mensaje de commit con IA y confirma los cambios.")
    parser.add_argument('--no-push', dest='push', action='store_false', help='Confirma los cambios localmente sin hacer push.')
