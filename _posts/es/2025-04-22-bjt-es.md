...
lang: es
layout: post
title: Transistores de Unión Bipolar (Gráfico)
translated: true
type: note
---
...
<svg viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Título -->
  <text x="400" y="30" font-family="Arial" font-size="24" text-anchor="middle" font-weight="bold">Características y Operación del BJT</text>
  
  <!-- Gráfico de Características de Salida -->
  <g transform="translate(50, 80)">
    <!-- Título del Gráfico -->
    <text x="175" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Características de Salida (Ic vs Vce)</text>
    ...
    <text x="175" y="230" font-family="Arial" font-size="14" text-anchor="middle">Voltaje Colector-Emisor (Vce)</text>
    <text x="-40" y="100" font-family="Arial" font-size="14" text-anchor="middle" transform="rotate(-90, -40, 100)">Corriente de Colector (Ic)</text>
    ...
    <text x="35" y="80" font-family="Arial" font-size="14" fill="#cc0000" text-anchor="middle">Saturación</text>
    <path d="M 35 85 L 35 150" stroke="#cc0000" stroke-width="1" stroke-dasharray="4,2" />
    
    <text x="175" y="60" font-family="Arial" font-size="14" fill="#006600" text-anchor="middle">Región Activa</text>
    <path d="M 100 40 L 340 40" stroke="#006600" stroke-width="1" stroke-dasharray="4,2" />
    
    <text x="300" y="180" font-family="Arial" font-size="14" fill="#660066" text-anchor="middle">Corte</text>
    <path d="M 300 185 L 300 200" stroke="#660066" stroke-width="1" stroke-dasharray="4,2" />
  </g>
  
  <!-- Gráfico de Características de Transferencia -->
  <g transform="translate(450, 80)">
    <!-- Título del Gráfico -->
    <text x="150" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Características de Transferencia (Ic vs Ib)</text>
    ...
    <!-- Etiquetas de los Ejes -->
    <text x="150" y="230" font-family="Arial" font-size="14" text-anchor="middle">Corriente de Base (Ib)</text>
    <text x="-40" y="100" font-family="Arial" font-size="14" text-anchor="middle" transform="rotate(-90, -40, 100)">Corriente de Colector (Ic)</text>
  ...
  <!-- Símbolo BJT y Flujo de Corriente (NPN) -->
  <g transform="translate(50, 350)">
    <!-- Título -->
    <text x="175" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Operación del Transistor NPN</text>
    ...
    <text x="220" y="40" font-family="Arial" font-size="14" text-anchor="start">Colector (C)</text>
    <text x="220" y="160" font-family="Arial" font-size="14" text-anchor="start">Emisor (E)</text>
    ...
    <text x="120" y="90" font-family="Arial" font-size="14" fill="#ff6600">IB (pequeña)</text>
    <text x="150" y="30" font-family="Arial" font-size="14" fill="#0066cc">IC (grande)</text>
    <text x="150" y="185" font-family="Arial" font-size="14" fill="#009933">IE = IB + IC</text>
    
    <!-- Fórmula -->
    <text x="100" y="210" font-family="Arial" font-size="16">Ganancia de Corriente: β = IC/IB (típicamente 50-200)</text>
  </g>
  
  <!-- Regiones de Operación del BJT -->
  <g transform="translate(450, 350)">
    <!-- Título -->
    <text x="150" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">Regiones de Operación del BJT</text>
    ...
    <text x="50" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">Corte</text>
    ...
    <text x="150" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">Activa</text>
    <text x="150" y="95" font-family="Arial" font-size="12" text-anchor="middle">Amplificación</text>
    
    <!-- Región de Saturación -->
    <rect x="200" y="50" width="100" height="50" fill="#f5d7d7" stroke="black" stroke-width="1" />
    <text x="250" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">Saturación</text>
    <text x="250" y="95" font-family="Arial" font-size="12" text-anchor="middle">Interruptor ON</text>
    
    <!-- Estados de Polarización de Uniones -->
    <rect x="0" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="50" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE: Inversa</text>
    <text x="50" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC: Inversa</text>
    
    <rect x="100" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="150" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE: Directa</text>
    <text x="150" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC: Inversa</text>
    
    <rect x="200" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="250" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE: Directa</text>
    <text x="250" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC: Directa</text>
    
    <!-- Información Adicional -->
    <text x="150" y="210" font-family="Arial" font-size="14" text-anchor="middle">BE = Unión Base-Emisor</text>
    <text x="150" y="230" font-family="Arial" font-size="14" text-anchor="middle">BC = Unión Base-Colector</text>
  </g>
