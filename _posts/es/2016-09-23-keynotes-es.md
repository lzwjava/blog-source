...
Este es el archivo README.md del proyecto de GitHub [https://github.com/lzwjava/Keynotes](https://github.com/lzwjava/Keynotes).

---

Apuntes:

* [Operaciones avanzadas y principios de Git](#Git)
* [WebSocket](#websocket)
* [UnitTest](#unittest)
* [Tecnología de transmisión en vivo sin reservas](#live)

Bienvenido a compartir, si tienes alguna pregunta, por favor, abre un [issue](https://github.com/lzwjava/Keynotes/issues/new), y responderé lo antes posible.
