...
lang: es
layout: post
title: Entendiendo el comando `ps` y sus opciones
translated: true
---
...
- **`-e`**: Esta opción selecciona todos los procesos, incluidos los ejecutados por otros usuarios, no solo los tuyos.
...
- **`-u usuario`**: Muestra los procesos propiedad de un usuario específico. Por ejemplo, `ps -u alice` lista todos los procesos ejecutados por el usuario "alice".
