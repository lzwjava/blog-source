...
El código se ejecuta correctamente, como se demuestra en el log a continuación.
...
Intentado reanudar la descarga...
...
02/04/2025 02:07:57 - [INFO] -BCEmbedding.models.EmbeddingModel->>>    Cargando desde `maidalun1020/bce-embedding-base_v1`.
02/04/2025 02:07:57 - [INFO] -BCEmbedding.models.EmbeddingModel->>>    Dispositivo de ejecución: cpu;	 número de gpu: 0;	 usar fp16: False;	 tipo de agrupación de embeddings: cls;	 confiar en código remoto: False
Extraer embeddings: 100%| 1/1 [00:00<00:00,  1.21it/s]
```
