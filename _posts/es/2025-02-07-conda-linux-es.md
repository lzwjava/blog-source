...
lang: es
layout: post
title: Eliminar Conda en Linux
translated: true
---

Eliminar `~/anaconda3` de forma recursiva y forzosa:

```bash
rm -rf ~/anaconda3
```

Eliminar el siguiente código en `.bashrc`:
...
Actualizar la variable de entorno PATH de:
