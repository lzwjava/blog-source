...
if args.device == "mps":
    ...
    print("Dispositivo especificado no válido, usando CPU en su lugar")
    device = torch.device("cpu")
...
print(result)
print(f"Tiempo tomado: {end_time - start_time:.4f} segundos")
```
...
Tiempo tomado: 2.8784 segundos

% python scripts/test_metal.py --device mps
Tiempo tomado: 0.0061 segundos
```