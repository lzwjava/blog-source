...
lang: es
layout: post
title: Tunelización SSH con Proxy
translated: true
---
...
He experimentado operaciones de `git push` lentas, con retrasos que ocurren durante la fase `ssh git@github.com`. Para abordar esto, configuré SSH para usar un proxy.

Para usar `corkscrew` para tunelización SSH, primero necesitarás instalarlo. En macOS, puedes usar Homebrew con el comando: `brew install corkscrew`.
