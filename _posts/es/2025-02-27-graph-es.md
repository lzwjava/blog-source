...
Los grafos modelan relaciones y sus algoritmos resuelven problemas como rutas más cortas y conectividad. Veamos DFS, BFS, Dijkstra y Kruskal.
...
## 3. Algoritmo de Dijkstra: Rutas Más Cortas
El algoritmo de Dijkstra encuentra la ruta más corta en un grafo ponderado.
...
Kruskal construye un MST ordenando aristas y añadiéndolas de forma greedy.
