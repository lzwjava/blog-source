...
Ve este enlace, [https://www.reddit.com/r/MachineLearning/comments/myl8yn/d_is_anaconda_worth_the_trouble/](https://www.reddit.com/r/MachineLearning/comments/myl8yn/d_is_anaconda_worth_the_trouble/).

Tengo problemas con conda, y otros han discutido problemas similares.

Con el tiempo, te olvidas de los diferentes ajustes de entorno. Así que tuve que eliminar los otros. Ahora, principalmente uso `Python 3.10.9`, y ocasionalmente `Python 3.11.11`. Sin embargo, uso incluso `Python 3.11.11` muy raramente. Personalmente, no necesito muchos entornos. Solo necesito uno o dos para ejecutar lo que estoy investigando o aprendiendo actualmente.

Prefiero una solución más sencilla. Si tengo dos proyectos que se entrechocan entre ellos, prefiero usar uno y renunciar a ejecutar el otro.

Por ejemplo, encontrar el siguiente problema es un verdadero dolor de cabeza.
...
Aunque configurar un proxy para conda pareció acelerar las cosas al principio, decidí eliminarlo al final.
...
Solving environment: /
El entorno es inconsistente, por favor revisa el plan de paquetes cuidadosamente
...
==> ADVERTENCIA: Existe una versión más nueva de conda. <==
  versión actual: 23.3.1
  última versión: 25.1.1

Por favor, actualiza conda ejecutando

    $ conda update -n base -c defaults conda

O para minimizar el número de paquetes actualizados durante la actualización de conda usa
...
Descargando y Extrayendo Paquetes

Preparando transacción: hecho
Verificando transacción: fallida
