...
lang: es
layout: post
title: 'Ingeniero de Frontend: Entrevista'
translated: true
---
...
6. Elementos Multimedia: Usar `<img>`, `<video>`, `<audio>` correctamente con atributos como `src`, `alt`, `controls`.

7. Listas: Crear listas ordenadas `<ol>` y desordenadas `<ul>`, incluyendo listas anidadas.
