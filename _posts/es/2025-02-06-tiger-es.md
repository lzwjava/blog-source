...
lang: es
layout: post
title: API Abierta de Comercio de Tiger
translated: true
---

Este fragmento de código recupera e imprime los precios actuales de acciones de algunas de las empresas más grandes que cotizan en la Bolsa de Hong Kong utilizando la API abierta de Tiger. Inicializa un cliente, recupera los precios de las acciones e imprime los resultados.
