...
* Todavía hay casos en los que necesitas usar Visual Studio Code, como para escenarios de edición de fusión de git, donde todavía uso `git config --global core.editor "code --wait"`.
...
* Al usar la API de DeepSeek o Mistral para traducir títulos con indicaciones como `Eres un traductor profesional. Estás traduciendo un archivo markdown para una publicación de blog de Jekyll del inglés al chino. {texto}`, puede llevar a traducciones incorrectas. Además del texto que proporcionas, la salida a menudo incluye una traducción excesiva.
...
* Al proporcionar un contexto amplio para tareas como la traducción o la generación de letras de diálogo, evita usar funciones de cadena de pensamiento, ya que puede ser lento y llevar a respuestas verbosas o inútiles.
