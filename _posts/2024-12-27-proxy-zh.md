...
* 如果想要方便的选择，可以使用 zhs.cloud。每月仅需 30 元人民币，即可访问大约 15 个全球服务器。
...
* 在 Android 上，使用 V2Ray。在 Fire TV 上，使用 V2Ray 应用。 在 Apple TV 上，使用 Shadowrocket 应用。在 Mac 上，使用 ShadowsocksX-NG 应用。
