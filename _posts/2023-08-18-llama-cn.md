---
layout: post
title: "安装 Nvidia 驱动，学习 LLaMA，并通过 ChatGPT 理解代码"
---

![llama](/assets/images/llama/gpu.jpg)

ChatGPT帮助翻译。原文文章是“Install Nvidia Driver, Learn LLaMA and Understand Code by ChatGPT" ，链接为[https://lzwjava.github.io/llama](https://lzwjava.github.io/llama)。
...
我刚刚使用 Nvidia GPU 组建了自己的电脑。你可以在这里查看：[如何组建一台电脑](https://lzwjava.github.io/computer)。
...
> RuntimeError: 期望所有张量都在相同的设备上，但发现至少两个设备，cuda:0 和 cpu！（在检

查方法 wrapper_CUDA__index_select 的参数索引时）
...
如果您想了解有关上述任务的更多详细信息，请查看日志，[https://github.com/lzwjava/logs](https://github.com/lzwjava/logs)，以及命令历史记录，[https://github.com/lzwjava/logs/tree/main/history](https://github.com/lzwjava/logs/tree/main/history)。