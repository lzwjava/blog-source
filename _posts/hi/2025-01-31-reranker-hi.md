...
reranker = FlagReranker('BAAI/bge-reranker-base', use_fp16=True) # use_fp16 को True सेट करने से गणना की गति बढ़ जाती है, लेकिन थोड़ा प्रदर्शन घट जाता है

score = reranker.compute_score(['query', 'passage'])
print(score) # -5.65234375

# आप स्कोर को 0-1 रेंज में म्याप कर सकते हैं, "normalize=True" सेट करने से, जो स्कोर पर एक सिग्मॉइड फंक्शन लागू करेगा।
