...
lang: hi
layout: post
title: टाइगर ट्रेड ओपन एपीआई उदाहरण
translated: true
---

यह कोड स्निपेट टाइगर ओपन एपीआई का उपयोग करके हांगकांग स्टॉक एक्सचेंज में सूचीबद्ध कुछ सबसे बड़ी कंपनियों की वर्तमान स्टॉक कीमतें प्राप्त करता है और प्रिंट करता है। यह एक क्लाइंट को इनिशियलाइज़ करता है, स्टॉक की कीमतें प्राप्त करता है, और परिणाम प्रिंट करता है।
