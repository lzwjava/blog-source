...
SSH टनलिंग के लिए `corkscrew` का उपयोग करने के लिए, आपको सबसे पहले इसे स्थापित करना होगा। macOS पर, आप इस आदेश के साथ Homebrew का उपयोग कर सकते हैं: `brew install corkscrew`।
...
"publickey" का उपयोग करके 138.201.174.0 (प्रॉक्सी के माध्यम से) के लिए प्रमाणित।
