...
मुझे धीमी `git push` ऑपरेशन का अनुभव हुआ, जिसमें `ssh git@github.com` चरण के दौरान देरी हो रही थी। इसे हल करने के लिए, मैंने SSH को प्रॉक्सी का उपयोग करने के लिए कॉन्फ़िगर किया।

SSH टनलिंग के लिए `corkscrew` का उपयोग करने के लिए, आपको पहले इसे स्थापित करना होगा। macOS पर, आप इस कमांड के साथ Homebrew का उपयोग कर सकते हैं: `brew install corkscrew`।
...
## आउटलाइन क्लाइंट के लिए निर्भरताएँ स्थापित करें

आउटलाइन क्लाइंट को चलने के लिए `fuse` की आवश्यकता होती है। इसे निम्नलिखित कमांड का उपयोग करके स्थापित करें:
