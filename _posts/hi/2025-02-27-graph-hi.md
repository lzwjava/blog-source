...
title: 'Graph Algorithms in Java
  ...
  ग्राफ एल्गोरिथम्स इन जावा'
translated: true
---

ग्राफ रिश्तों को मॉडल करते हैं, और उनके एल्गोरिथम समस्याओं जैसे कि सबसे छोटी पथ और कनेक्टिविटी को हल करते हैं। हम DFS, BFS, Dijkstra’s, और Kruskal’s को कवर करेंगे।

## 1. DFS: गहनता-प्रथम खोज
DFS प्रत्येक शाखा के साथ जितना संभव हो सके उतना दूर तक खोजता है, फिर वापस आता है।
...
## 2. BFS: चौड़ाई-प्रथम खोज
BFS एक क्यू का उपयोग करके स्तर-दर-स्तर खोज करता है।
...
## 3. Dijkstra’s एल्गोरिथम: सबसे छोटी पथ
Dijkstra’s एक वेटेड ग्राफ में सबसे छोटी पथ पाता है।
...
## 4. Kruskal’s एल्गोरिथम: न्यूनतम स्पैनिंग ट्री
Kruskal’s एक MST बनाता है, एज को सॉर्ट करके और उन्हें लालच से जोड़कर।
