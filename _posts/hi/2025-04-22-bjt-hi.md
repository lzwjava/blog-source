...
lang: hi
layout: post
title: द्विध्रुवी जंक्शन ट्रांजिस्टर (ग्राफ)
translated: true
type: note
---
...
<svg viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Title -->
  <text x="400" y="30" font-family="Arial" font-size="24" text-anchor="middle" font-weight="bold">BJT की विशेषताएँ और संचालन</text>
  
  <!-- Output Characteristics Graph -->
  <g transform="translate(50, 80)">
    <!-- Graph Title -->
    <text x="175" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">आउटपुट विशेषताएँ (Ic बनाम Vce)</text>
    ...
    <!-- Axis Labels -->
    <text x="175" y="230" font-family="Arial" font-size="14" text-anchor="middle">कलेक्टर-एमिटर वोल्टेज (Vce)</text>
    <text x="-40" y="100" font-family="Arial" font-size="14" text-anchor="middle" transform="rotate(-90, -40, 100)">कलेक्टर करंट (Ic)</text>
    ...
    <!-- Region Labels -->
    <text x="35" y="80" font-family="Arial" font-size="14" fill="#cc0000" text-anchor="middle">संतृप्ति</text>
    <path d="M 35 85 L 35 150" stroke="#cc0000" stroke-width="1" stroke-dasharray="4,2" />
    
    <text x="175" y="60" font-family="Arial" font-size="14" fill="#006600" text-anchor="middle">सक्रिय क्षेत्र</text>
    <path d="M 100 40 L 340 40" stroke="#006600" stroke-width="1" stroke-dasharray="4,2" />
    
    <text x="300" y="180" font-family="Arial" font-size="14" fill="#660066" text-anchor="middle">कटऑफ</text>
  ...
  <g transform="translate(450, 80)">
    <!-- Graph Title -->
    <text x="150" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">स्थानांतरण विशेषताएँ (Ic बनाम Ib)</text>
    ...
    <!-- Axis Labels -->
    <text x="150" y="230" font-family="Arial" font-size="14" text-anchor="middle">बेस करंट (Ib)</text>
    <text x="-40" y="100" font-family="Arial" font-size="14" text-anchor="middle" transform="rotate(-90, -40, 100)">कलेक्टर करंट (Ic)</text>
  ...
  <g transform="translate(50, 350)">
    <!-- Title -->
    <text x="175" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">NPN ट्रांजिस्टर संचालन</text>
    ...
    <!-- Terminal Labels -->
    <text x="130" y="70" font-family="Arial" font-size="14" text-anchor="end">बेस (B)</text>
    <text x="130" y="50" font-family="Arial" font-size="12" text-anchor="end">नियंत्रण</text>
    <text x="220" y="40" font-family="Arial" font-size="14" text-anchor="start">कलेक्टर (C)</text>
    <text x="220" y="160" font-family="Arial" font-size="14" text-anchor="start">एमिटर (E)</text>
    ...
    <!-- Current Labels -->
    <text x="120" y="90" font-family="Arial" font-size="14" fill="#ff6600">IB (छोटा)</text>
    <text x="150" y="30" font-family="Arial" font-size="14" fill="#0066cc">IC (बड़ा)</text>
    <text x="150" y="185" font-family="Arial" font-size="14" fill="#009933">IE = IB + IC</text>
    
    <!-- Formula -->
    <text x="100" y="210" font-family="Arial" font-size="16">करंट गेन: β = IC/IB (आमतौर पर 50-200)</text>
  </g>
  
  <!-- BJT Regions of Operation -->
  <g transform="translate(450, 350)">
    <!-- Title -->
    <text x="150" y="20" font-family="Arial" font-size="18" text-anchor="middle" font-weight="bold">BJT संचालन क्षेत्र</text>
    ...
    <text x="50" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">कटऑफ</text>
    ...
    <text x="150" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">सक्रिय</text>
    <text x="150" y="95" font-family="Arial" font-size="12" text-anchor="middle">प्रवर्धन</text>
    
    <!-- Saturation Region -->
    <rect x="200" y="50" width="100" height="50" fill="#f5d7d7" stroke="black" stroke-width="1" />
    <text x="250" y="75" font-family="Arial" font-size="14" text-anchor="middle" font-weight="bold">संतृप्ति</text>
    <text x="250" y="95" font-family="Arial" font-size="12" text-anchor="middle">स्विच ON</text>
    
    <!-- Junction Bias States -->
    <rect x="0" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="50" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE: रिवर्स</text>
    <text x="50" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC: रिवर्स</text>
    
    <rect x="100" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="150" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE: फॉरवर्ड</text>
    <text x="150" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC: रिवर्स</text>
    
    <rect x="200" y="100" width="100" height="50" fill="#eeeeee" stroke="black" stroke-width="1" />
    <text x="250" y="120" font-family="Arial" font-size="12" text-anchor="middle">BE: फॉरवर्ड</text>
    <text x="250" y="140" font-family="Arial" font-size="12" text-anchor="middle">BC: फॉरवर्ड</text>
    
    <!-- Additional Info -->
    <text x="150" y="210" font-family="Arial" font-size="14" text-anchor="middle">BE = बेस-एमिटर जंक्शन</text>
    <text x="150" y="230" font-family="Arial" font-size="14" text-anchor="middle">BC = बेस-कलेक्टर जंक्शन</text>
  </g>
