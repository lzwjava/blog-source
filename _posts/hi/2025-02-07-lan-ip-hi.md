...
यह पाइथन स्क्रिप्ट सक्रिय IP पतों के लिए एक स्थानीय नेटवर्क को स्कैन करता है। यह जाँचने के लिए कि कोई होस्ट पहुँचा जा सकता है या नहीं, `ping` कमांड का उपयोग करता है और स्कैनिंग प्रक्रिया को गति देने के लिए मल्टीथ्रेडिंग का उपयोग करता है। सिस्टम को अतिभारित करने से बचने के लिए एक सेमाफोर समवर्ती थ्रेड्स की संख्या को सीमित करता है। स्क्रिप्ट इनपुट के रूप में एक नेटवर्क पता (जैसे, "192.168.1.0/24") लेती है और प्रिंट करती है कि नेटवर्क में प्रत्येक IP पता चालू है या बंद।

यह स्क्रिप्ट सक्रिय IP पतों के लिए स्कैन करके नेटवर्क पर उपकरणों की पहचान करने में मदद करती है, जैसे कि वायर्ड ब्रिज मोड में काम कर रहा TP-LINK मेष राउटर।
...
MAX_THREADS = 50  # उपयोग किए जाने वाले थ्रेड्स की अधिकतम संख्या

def is_host_up(host, port=None):
    """
    ping या telnet का उपयोग करके जाँचता है कि कोई होस्ट चालू है या नहीं।
    यदि पोर्ट निर्दिष्ट है, तो यह जाँचने के लिए कि पोर्ट खुला है या नहीं, telnet का उपयोग करता है।
...
def scan_network(network, port=None):
    ...
    """
    print(f"नेटवर्क स्कैन कर रहा है: {network}")
    threads = []
...
## स्थानीय IPs को दरकिनार करना

स्क्रिप्ट सक्रिय IP पतों की पहचान करती है। उचित नेटवर्क संचार सुनिश्चित करने के लिए, सत्यापित करें कि प्रॉक्सी सेटिंग्स इन स्थानीय IPs को दरकिनार करने के लिए कॉन्फ़िगर की गई हैं।
