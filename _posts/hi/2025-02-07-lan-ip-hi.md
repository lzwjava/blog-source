...
यह पायथन स्क्रिप्ट सक्रिय IP पतों के लिए एक स्थानीय नेटवर्क को स्कैन करता है। यह जांचने के लिए कि क्या कोई होस्ट पहुँचा जा सकता है, `ping` कमांड का उपयोग करता है और स्कैनिंग प्रक्रिया को तेज करने के लिए मल्टीथ्रेडिंग का उपयोग करता है। सिस्टम को अभिभूत करने से बचने के लिए एक सेमाफोर समवर्ती थ्रेड्स की संख्या को सीमित करता है। स्क्रिप्ट इनपुट के रूप में एक नेटवर्क पता (जैसे, "192.168.1.0/24") लेती है और प्रिंट करती है कि नेटवर्क में प्रत्येक IP पता चालू है या बंद।

यह स्क्रिप्ट सक्रिय IP पतों के लिए स्कैन करके नेटवर्क पर उपकरणों की पहचान करने में मदद करती है, जैसे कि वायर्ड ब्रिज मोड में संचालित एक TP-LINK मेष राउटर।
...
def is_host_up(host, port=None):
    ...
    यदि पोर्ट निर्दिष्ट किया गया है, तो यह जाँचने के लिए कि क्या पोर्ट खुला है, telnet का उपयोग करता है।
...
def scan_ip(ip_str, up_ips, port=None):
    """
    एकल IP पते को स्कैन करता है और इसकी स्थिति प्रिंट करता है।
    """
...
स्क्रिप्ट सक्रिय IP पतों की पहचान करती है। उचित नेटवर्क संचार सुनिश्चित करने के लिए, सत्यापित करें कि प्रॉक्सी सेटिंग्स को इन स्थानीय IPs को बाईपास करने के लिए कॉन्फ़िगर किया गया है।
...
आमतौर पर, मेरी मशीन 192.168.1.16 पर है।
