...
इस पायथन स्क्रिप्ट को आपके सिस्टम के PATH में शामिल किसी डायरेक्टरी में रखा जाना चाहिए, जैसे `~/bin`।
...
* एक यह है कि केवल फ़ाइल नाम परिवर्तनों को भेजा जाए, और `git diff` का उपयोग करके फ़ाइल के विस्तृत परिवर्तनों को न पढ़ा जाए। हम AI सेवा API को बहुत ज्यादा विवरण नहीं देना चाहते। इस मामले में, हमें इसकी आवश्यकता नहीं है, क्योंकि कमिट संदेशों को ध्यान से पढ़ने वाले बहुत कम लोग होंगे।

* कभी-कभी, Deepseek API विफल हो सकता है, क्योंकि यह हाल ही में बहुत लोकप्रिय हो गया है। हमें इसके बजाय Gemini का उपयोग करना पड़ सकता है।