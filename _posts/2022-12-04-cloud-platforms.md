...
My custom networking setting is simple. I just make any port between 1024 to 65535 of any protocol open. As it is my proxy server. I don't have any secure data or program inside it. So I follow the suggestion of the Outline App to do so.
...
The cheapest sever with the lowest configuration usually cost around 5 dollars a month. It is enough for acting as a proxy to be used for a few users. The servers in Singapore, HongKong or in Asia, are usually connected faster than the servers in USA or Europe. 
