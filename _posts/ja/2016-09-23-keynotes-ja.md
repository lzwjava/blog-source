...
交流を歓迎します。問題があれば[issue](https://github.com/lzwjava/Keynotes/issues/new)を提出してください。確認後、迅速に回答いたします。
...
2015.12.20 斗鱼TVでライブしたKeynote。単元テスト、自動化、便利なツールなどに関して。動画: http://reviewcode.cn/video.html?videoId=2
...
彦祖、ufosky、tang3w、sunng87、iOSプログラマ、冉神に感謝します。LeanCloudのCTOが内部テストプロセスを話すことを許可してくれてありがとうございます。