...
lang: ja
layout: post
title: Javaにおけるグラフアルゴリズム
translated: true
type: note
---

グラフは関係性をモデル化し、そのアルゴリズムは最短経路や連結性などの問題を解決します。DFS、BFS、ダイクストラ法、クラスカル法について説明します。

## 1. DFS: 深さ優先探索
DFSはバックトラックする前に各ブランチを可能な限り探索します。
...
## 4. クラスカル法: 最小全域木
クラスカル法は辺をソートして貪欲に追加することでMSTを構築します。
