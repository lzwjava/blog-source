...
lang: ja
layout: post
title: Spring Bootのパッケージを分析する
translated: true
---

ディレクトリの解析を開始しました: /Users/lzwjava/projects/spring-boot レベル2で出現回数:

```bash
[INFO] ディレクトリの解析を開始しました: /Users/lzwjava/projects/spring-boot レベル2で出現回数
[INFO] 試行したJavaファイルの合計: 7485
[INFO] 成功して処理されたファイル: 7485
[INFO] エラーのあるファイル: 0
[INFO] 独自のパッケージの合計: 204
[INFO] 解析完了。出現回数でソートされた独自のパッケージを表示します:
...
ディレクトリの解析を開始しました: /Users/lzwjava/projects/spring-boot レベル3で出現回数:

```bash
[INFO] ディレクトリの解析を開始しました: /Users/lzwjava/projects/spring-boot レベル3で出現回数
[INFO] 試行したJavaファイルの合計: 7485
[INFO] 成功して処理されたファイル: 7485
[INFO] エラーのあるファイル: 0
[INFO] 独自のパッケージの合計: 498
[INFO] 解析完了。出現回数でソートされた独自のパッケージを表示します:
