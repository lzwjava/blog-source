...
lang: ja
layout: post
title: Spring Bootにおけるパッケージ分析
translated: true
type: note
---

ディレクトリの分析を開始: /Users/lzwjava/projects/spring-boot レベル2での出現回数:

```bash
[INFO] ディレクトリの分析を開始: /Users/lzwjava/projects/spring-boot レベル2での出現回数
[INFO] 処理を試行したJavaファイルの総数: 7485
[INFO] 正常に処理されたファイル: 7485
[INFO] エラーが発生したファイル: 0
[INFO] 一意なパッケージの総数（回数付き）: 204
[INFO] 分析完了。一意なパッケージを回数の降順で表示:
...
ディレクトリの分析を開始: /Users/lzwjava/projects/spring-boot レベル3での出現回数:

```bash
[INFO] ディレクトリの分析を開始: /Users/lzwjava/projects/spring-boot レベル3での出現回数
[INFO] 処理を試行したJavaファイルの総数: 7485
[INFO] 正常に処理されたファイル: 7485
[INFO] エラーが発生したファイル: 0
[INFO] 一意なパッケージの総数（回数付き）: 498
[INFO] 分析完了。一意なパッケージを回数の降順で表示:
