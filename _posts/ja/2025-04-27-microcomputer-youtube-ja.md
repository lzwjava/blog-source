...
lang: ja
layout: post
title: マイクロコンピュータに関する動画のおすすめ
translated: true
type: note
---

「マイクロコンピュータとインタフェース技術」のコース概要に含まれるトピックをカバーする、おすすめのYouTube動画とプレイリストを以下に紹介します：
...
* **Assembly Language programming tutorial 8086 in hindi learn full course with examples for beginners** by Malik Shahzaib Official (プレイリスト) ([http://www.youtube.com/playlist?list=PLAZj-jE2acZLdYT7HLFgNph190z2cjmAG](http://www.youtube.com/playlist?list=PLAZj-jE2acZLdYT7HLFgNph190z2cjmAG))
...
これらのリソースは、マイクロコンピュータとインタフェース技術コースのトピックを探求するための良い出発点となるはずです。

特定のトピックやチップに関するおすすめ情報があれば、お知らせください！