...
After a whole day of fixing, about 8 hours of work, he told me it was okay now. It was a problem with the car's tailpipe. The tailpipe was full of hairs. When I pressed the accelerator for some time, the hairs would gather and block the air intake of the engine. So, the engine couldn't run at full speed, just at about half speed. And if I didn't press the accelerator, the hairs would move a little further from the air intake, so the car would go a little faster.

So, the car repair expert removed all the hairs and changed some automotive components.

This was an unforgettable experience, highlighting the importance of root cause analysis, much like in programming.
