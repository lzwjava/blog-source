...
Added Mistral Small 2501 (API) to my MMLU benchmark testing. It achieved an accuracy of 66.0% in the college computer science subject, which is lower than Mistral Large Latest (73.00%). Both are also lower than DeepSeek v3 (78.00%) and DeepSeek R1 (87.14%). Models without chain-of-thought capabilities are proving difficult to outperform those that have it. Blog below.
