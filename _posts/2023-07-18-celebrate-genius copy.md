...
I feel very painful working in data-sensitive companies. They shouldn't block most of the social media or video websites. Nowadays, a lot of innovative ideas happened on Twitter, and Youtube. If they don't allow employees to share, at least they should allow employees to read or watch. Or better, We can train the large language models about all sensitive data of the company. The models will be very smart enough to detect whether it contains sensitive data.Their security firewalls and policies are outdated in the AI era. 
