...
* For example, the optician might insert:

  1. A spherical lens (basic myopia or hyperopia correction)
  2. A cylindrical lens (astigmatism correction)
  3. A prism lens (if needed, or an additional test lens such as progressive trial lens)
