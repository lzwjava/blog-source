...
1. **Polymer synthesis**: reacting a diisocyanate with a macroglycol to form a prepolymer.
2. **Chain extension**: adding a diamine to lengthen polymer chains.
3. **Dry spinning**: dissolving the polymer in solvent and extruding it through spinnerets into a heated chamber.
4. **Solidification**: the solvent evaporates, leaving fine elastic filaments.
5. **Finishing**: fibers are coated with lubricants to ease weaving and blending.
...
Spandex is **petroleum-based** and **non-recyclable** through ordinary means.
However, researchers are developing **bio-based elastane alternatives** and **chemical recycling methods** to reduce its environmental footprint.
