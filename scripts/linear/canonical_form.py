...
print("Computed Characteristic Polynomial from Eigenvalues:", computed_characteristic_polynomial)
...
if np.allclose(characteristic_polynomial, computed_characteristic_polynomial):
    ...
    print("Eigenvalues might be incorrect: The characteristic polynomial does not match.")
