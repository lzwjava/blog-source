...
os.environ['FLAGEMBEDDING_LOG_LEVEL'] = 'DEBUG'  # Enable debug logging for FlagEmbedding
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('bge_reranker.log')
    ]
)
logger = logging.getLogger(__name__)

logger.debug("Starting FlagReranker initialization...")
logger.info("Initializing FlagReranker with model 'BAAI/bge-reranker-base' and fp16 enabled")
...
logger.info(f"Normalized scores: {scores}")  # [0.00027803096387751553, 0.9948403768236574]
