...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Create a new post from a README file.")
    parser.add_argument("project_dir", type=str, help="The root directory of the project.")
    parser.add_argument("target_post", type=str, help="The target directory for the new post.")
