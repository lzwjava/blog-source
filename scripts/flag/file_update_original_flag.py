...
def update_front_matter(file_path, audio_flag=False, lang=None):
    try:
        ...
        if lang:
            if 'lang' in front_matter_dict:
                if front_matter_dict['lang'] != lang:
                    print(f"  Correcting language from {front_matter_dict['lang']} to {lang} in {file_path}")
        ...
        print(f"Updated front matter in {file_path}, audio set to {audio_flag}, lang set to {lang}")
