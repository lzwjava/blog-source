...
You can download the PDF version of my resume, created with LaTeX, [here](/assets/resume/Zhiwei.Li.Resume.pdf). You can also find the Chinese version [here](/assets/resume/Zhiwei.Li.Resume.ZH.pdf).
...
* Primarily worked at LeanCloud, Beijing Square Root, Beyondsoft (outsourced to DBS Bank), Farben Information (outsourced to HSBC Bank), and TEKsystems (outsourced to HSBC Bank).
...
* Allegis-BN Human Resources Consultants (Shanghai) Ltd. Guangzhou Branch is a subsidiary of TEKsystems, and thus part of Allegis Group, Inc., a multinational talent management firm. I worked in a backend engineer position, outsourced to HSBC Bank, a leading global financial institution.
* This role involves developing and optimizing backend systems within HSBC’s Enterprise Technology Department, utilizing technologies such as Spring, Spring Boot, Java, multithreading, networking, Maven, Nexus, and development in Windows, Eclipse, and IBM WebSphere Application Server.
...
* Maintained a technical blog with 431 original blog posts. Utilized large language models to translate content into 9 languages, provide text-to-speech audio, support PDF and EPUB formats, integrate with GitHub workflows, and use LaTeX for writing papers or creating a resume. Other technologies employed include Jekyll, Deepseek, and Mistral. Conducted experiments with llama.cpp, embeddings, Retrieval-Augmented Generation, and the MMLU benchmark. The website is https://lzwjava.github.io.
