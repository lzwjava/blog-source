...
* Maintained a technical blog with 300 blog posts. Utilized large language models to translate content into 9 languages, provide text-to-speech audio, support PDF and EPUB formats, integrate with GitHub workflows, and use LaTeX for writing papers or creating a resume. Other technologies employed include Jekyll, Deepseek, and Mistral. Conducted experiments with llama.cpp, embeddings, Retrieval-Augmented Generation, and the MMLU benchmark. The website is https://lzwjava.github.io.
