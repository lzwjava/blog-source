...
For instance, encountering the following problem is a real hassle:
...
After restarting iTerm2, I decided to switch to Homebrew's Python installation. It seemed like there were multiple Python installations on my computer, and I already had six, as shown below.
...
Delete with command, `brew uninstall python@3.11`.
...
pip3 install --upgrade pip --break-system-package
```
