...
5. **Install and Configure LightDM:**
   - If the issue persists, you can try installing as an alternative display manager:
     ```bash
     sudo apt-get install lightdm
     ```
   - After installing lightdm, the system will promt you to set default display manger.
