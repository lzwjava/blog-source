...
Gmail can be greatly improved in the AI era. I sent some epub files to the Send-to-Kindle service, and it reported a document conversion error. These actions are user-initiated triggers and should be categorized as primary for me. However, these kinds of filters should be different for different users. It would be better to learn from users' behavior, such as whether they open, interact with, or actively trigger them. Information is meant to be read or checked. Furthermore, an RAG or LLM-driven mail app will likely become popular in the future.
