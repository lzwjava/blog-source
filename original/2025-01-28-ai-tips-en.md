...
* Why upgrade Figma to be AI-powered to create user interfaces when we can directly use code to generate user interfaces, as the latter will be powered by AI?
