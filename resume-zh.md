...
* 在我的空闲时间，我学习了神经网络，并使用 Python 与 PyTorch 来识别 MNIST 数据集中的模式。
...
* 已通过四门课程：操作系统概论, 数据结构导论, 高级语言程序设计(一), 英语(一). 

### 北京林业大学, 计算机科学, 学士（中途退学）, 2013.09 - 2014.06

* 通过15门课程，计算机导论、专业概论、程序设计基础、程序设计基础实验、大学英语、高等数学A、管理学基础、思想道德修养与法律基础、数字影像原理与技术、体育、大学英语二、二维图形技术、二维图形技术(课程设计)、二维图形技术实验、大学生学习引论。
