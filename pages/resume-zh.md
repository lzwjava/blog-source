...
* 参与了一个使用Claude的API生成个性化故事的AI驱动故事机器人项目，担任全栈开发人员。该机器人支持提示词设置，并包含一个用于配置的管理页面。我们使用Python、Flask和React进行开发，并部署在AWS上。DNS管理通过GoDaddy和Cloudflare处理。Nginx被用作网关，负责SSL证书和请求头管理。此外，我们使用Prometheus进行监控，并利用Elastic Search、Kibana和Logstash进行日志管理。我们还使用ChatGPT 4.0来协助编程。
