...
* 作为全栈开发人员，我参与了一个使用Claude API生成个性化故事的AI驱动故事机器人项目。该机器人支持多轮对话、自定义提示、故事设定和HTTP流内容输出，并包含一个用于配置的管理页面。我们使用了Python、Flask、React进行开发，部署在AWS上，并使用GoDaddy、nginx和Prometheus进行监控，同时利用ChatGPT 4o协助编程。
