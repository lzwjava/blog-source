...
* 全国高等教育自学考试。已通过5门课程：操作系统概论, 数据结构导论, 高级语言程序设计(一), 英语(一), 高等数学。* 正在备考计算机组成原理、计算机网络技术、数据库及其应用、计算机应用技术、线性代数、电子技术基础、微型计算机及接口技术等课程。
...
* 行业知识: 银行和支付、教育和在线学习平台、社交媒体和内容平台、用户和账户管理、通知系统、数据和分析、移动应用、支付系统、交易管理、社交媒体整合、视频管理、奖励系统、实时观看跟踪、应用管理、共同基金和股票交易、基于浏览器的编程环境。
* 计算机科学基础: 高等数学、计算机组成原理、操作系统、计算机网络技术、数据库及其应用、计算机应用技术、数据结构与算法、微型计算机及接口技术、编译器设计与构造。
* 技术和开发: 多语言交流、跨平台开发、全栈编程、数据库管理、机器学习和大数据、数学能力、开发工具、机器学习实现、高级 Linux 使用、测试和质量保证、API 集成、开源贡献、技术写作和博客、云计算服务、分布式系统。
