...
* Participated as a Full Stack Developer on an AI-powered web app for generating personalized stories using Claude AI's API. The bot supports multi-round conversations, customizable prompts, story settings, HTTP streaming content output, and includes an admin page for configuration. We used Python, Flask, React, AWS for deployment, GoDaddy, Claude, nginx, and Prometheus for monitoring, and utilized ChatGPT 4o to assist with programming.
